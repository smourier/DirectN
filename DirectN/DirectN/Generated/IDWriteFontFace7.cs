...
namespace DirectN
{
    ...
    public partial interface IDWriteFontFace7 : IDWriteFontFace6
    {
        ...
        // IDWriteFontFace6
        [PreserveSig]
        new HRESULT GetFamilyNames(DWRITE_FONT_FAMILY_MODEL fontFamilyModel, /* _COM_Outptr_ */ out IDWriteLocalizedStrings names);
        
        [PreserveSig]
        new HRESULT GetFaceNames(DWRITE_FONT_FAMILY_MODEL fontFamilyModel, /* _COM_Outptr_ */ out IDWriteLocalizedStrings names);
        ...
        [PreserveSig]
        HRESULT CreatePaintReader(DWRITE_GLYPH_IMAGE_FORMATS glyphImageFormat, DWRITE_PAINT_FEATURE_LEVEL paintFeatureLevel, /* _COM_Outptr_ */ out IDWritePaintReader paintReader);
    }
}
