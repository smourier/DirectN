// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d10effect.h(489,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D10EffectVectorVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT GetRawValue(/* THIS_ _Out_writes_bytes_(ByteCount) */ IntPtr pData, uint ByteOffset, uint ByteCount);
