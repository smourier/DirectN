...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT GetPropertyDescription(/* [in] __RPC__in */ ref PROPERTYKEY propkey, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [iid_is][out] __RPC__deref_out_opt */ [MarshalAs(UnmanagedType.IUnknown)] out object ppv);
        ...
        [PreserveSig]
        HRESULT FormatForDisplay(/* [in] __RPC__in */ ref PROPERTYKEY key, /* [in] __RPC__in */ PropVariant propvar, /* [in] */ PROPDESC_FORMAT_FLAGS pdff, /* [size_is][string][out] __RPC__out_ecount_full_string(cchText) */ [MarshalAs(UnmanagedType.LPWStr)] string pszText, /* [range][in] __RPC__in_range(0,0x8000) */ uint cchText);
        
        [PreserveSig]
        HRESULT FormatForDisplayAlloc(/* [in] __RPC__in */ ref PROPERTYKEY key, /* [in] __RPC__in */ PropVariant propvar, /* [in] */ PROPDESC_FORMAT_FLAGS pdff, /* optional(LPWSTR) */ out IntPtr ppszDisplay);
