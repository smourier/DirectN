...
namespace DirectN
{
    ...
    public partial interface IDXGIFactory4 : IDXGIFactory3
    {
        ...
        // IDXGIFactory4
        [PreserveSig]
        HRESULT EnumAdapterByLuid(/* [annotation] _In_ */ _LUID AdapterLuid, /* [annotation] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [annotation] _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvAdapter);
