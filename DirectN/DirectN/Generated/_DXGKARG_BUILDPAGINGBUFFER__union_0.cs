...
namespace DirectN
{
    ...
    public partial struct _DXGKARG_BUILDPAGINGBUFFER__union_0
    {
        ...
        public byte[] __bits;
        public _DXGKARG_BUILDPAGINGBUFFER__union_0__struct_0 Transfer { get => InteropRuntime.Get<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_0>(__bits, 0, 512); set { if (__bits == null) __bits = new byte[256]; InteropRuntime.Set<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_0>(value, __bits, 0, 512); } }
        ...
        public _DXGKARG_BUILDPAGINGBUFFER__union_0__struct_5 MapApertureSegment { get => InteropRuntime.Get<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_5>(__bits, 0, 416); set { if (__bits == null) __bits = new byte[256]; InteropRuntime.Set<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_5>(value, __bits, 0, 416); } }
        ...
        public _DXGKARG_BUILDPAGINGBUFFER__union_0__struct_7 SpecialLockTransfer { get => InteropRuntime.Get<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_7>(__bits, 0, 544); set { if (__bits == null) __bits = new byte[256]; InteropRuntime.Set<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_7>(value, __bits, 0, 544); } }
        public _DXGKARG_BUILDPAGINGBUFFER__union_0__struct_8 InitContextResource { get => InteropRuntime.Get<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_8>(__bits, 0, 320); set { if (__bits == null) __bits = new byte[256]; InteropRuntime.Set<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_8>(value, __bits, 0, 320); } }
        ...
        public _DXGKARG_BUILDPAGINGBUFFER__union_0__struct_9 Reserved { get => InteropRuntime.Get<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_9>(__bits, 0, 2048); set { if (__bits == null) __bits = new byte[256]; InteropRuntime.Set<_DXGKARG_BUILDPAGINGBUFFER__union_0__struct_9>(value, __bits, 0, 2048); } }
    }
}
