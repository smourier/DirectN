...
namespace DirectN
{
    ...
    public partial interface ID3D12Device14 : ID3D12Device13
    {
        ...
        // ID3D12Device7
        [PreserveSig]
        new HRESULT AddToStateObject(ref D3D12_STATE_OBJECT_DESC pAddition, ID3D12StateObject pStateObjectToGrowFrom, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppNewStateObject);
        
        [PreserveSig]
        new HRESULT CreateProtectedResourceSession1(/* _In_ */ ref D3D12_PROTECTED_RESOURCE_SESSION_DESC1 pDesc, /* _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppSession);
        
        // ID3D12Device8
        [PreserveSig]
        new D3D12_RESOURCE_ALLOCATION_INFO GetResourceAllocationInfo2(uint visibleMask, int numResourceDescs, /* _In_reads_(numResourceDescs) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RESOURCE_DESC1[] pResourceDescs, /* _Out_writes_opt_(numResourceDescs) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RESOURCE_ALLOCATION_INFO1[] pResourceAllocationInfo1);
        
        [PreserveSig]
        new HRESULT CreateCommittedResource2(/* _In_ */ ref D3D12_HEAP_PROPERTIES pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, /* _In_ */ ref D3D12_RESOURCE_DESC1 pDesc, D3D12_RESOURCE_STATES InitialResourceState, /* optional(D3D12_CLEAR_VALUE) */ IntPtr pOptimizedClearValue, /* _In_opt_ */ ID3D12ProtectedResourceSession pProtectedSession, [MarshalAs(UnmanagedType.LPStruct)] Guid riidResource, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        [PreserveSig]
        new HRESULT CreatePlacedResource1(/* _In_ */ ID3D12Heap pHeap, ulong HeapOffset, /* _In_ */ ref D3D12_RESOURCE_DESC1 pDesc, D3D12_RESOURCE_STATES InitialState, /* optional(D3D12_CLEAR_VALUE) */ IntPtr pOptimizedClearValue, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        [PreserveSig]
        new void CreateSamplerFeedbackUnorderedAccessView(/* _In_opt_ */ ID3D12Resource pTargetedResource, /* _In_opt_ */ ID3D12Resource pFeedbackResource, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        [PreserveSig]
        new void GetCopyableFootprints1(/* _In_ */ ref D3D12_RESOURCE_DESC1 pResourceDesc, /* _In_range_(0,D3D12_REQ_SUBRESOURCES) */ uint FirstSubresource, /* _In_range_(0,D3D12_REQ_SUBRESOURCES-FirstSubresource) */ int NumSubresources, ulong BaseOffset, /* _Out_writes_opt_(NumSubresources) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] D3D12_PLACED_SUBRESOURCE_FOOTPRINT[] pLayouts, /* _Out_writes_opt_(NumSubresources) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] uint[] pNumRows, /* _Out_writes_opt_(NumSubresources) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ulong[] pRowSizeInBytes, /* optional(UINT64) */ IntPtr pTotalBytes);
        
        // ID3D12Device9
        [PreserveSig]
        new HRESULT CreateShaderCacheSession(/* _In_ */ ref D3D12_SHADER_CACHE_SESSION_DESC pDesc, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvSession);
        
        [PreserveSig]
        new HRESULT ShaderCacheControl(D3D12_SHADER_CACHE_KIND_FLAGS Kinds, D3D12_SHADER_CACHE_CONTROL_FLAGS Control);
        
        [PreserveSig]
        new HRESULT CreateCommandQueue1(/* _In_ */ ref D3D12_COMMAND_QUEUE_DESC pDesc, [MarshalAs(UnmanagedType.LPStruct)] Guid CreatorID, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppCommandQueue);
        
        // ID3D12Device10
        [PreserveSig]
        new HRESULT CreateCommittedResource3(/* _In_ */ ref D3D12_HEAP_PROPERTIES pHeapProperties, D3D12_HEAP_FLAGS HeapFlags, /* _In_ */ ref D3D12_RESOURCE_DESC1 pDesc, D3D12_BARRIER_LAYOUT InitialLayout, /* optional(D3D12_CLEAR_VALUE) */ IntPtr pOptimizedClearValue, /* _In_opt_ */ ID3D12ProtectedResourceSession pProtectedSession, int NumCastableFormats, /* _In_opt_count_(NumCastableFormats) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] DXGI_FORMAT[] pCastableFormats, [MarshalAs(UnmanagedType.LPStruct)] Guid riidResource, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        [PreserveSig]
        new HRESULT CreatePlacedResource2(/* _In_ */ ID3D12Heap pHeap, ulong HeapOffset, /* _In_ */ ref D3D12_RESOURCE_DESC1 pDesc, D3D12_BARRIER_LAYOUT InitialLayout, /* optional(D3D12_CLEAR_VALUE) */ IntPtr pOptimizedClearValue, int NumCastableFormats, /* _In_opt_count_(NumCastableFormats) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] DXGI_FORMAT[] pCastableFormats, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        [PreserveSig]
        new HRESULT CreateReservedResource2(/* _In_ */ ref D3D12_RESOURCE_DESC pDesc, D3D12_BARRIER_LAYOUT InitialLayout, /* optional(D3D12_CLEAR_VALUE) */ IntPtr pOptimizedClearValue, /* _In_opt_ */ ID3D12ProtectedResourceSession pProtectedSession, int NumCastableFormats, /* _In_opt_count_(NumCastableFormats) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] DXGI_FORMAT[] pCastableFormats, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        // ID3D12Device11
        [PreserveSig]
        new void CreateSampler2(/* _In_ */ ref D3D12_SAMPLER_DESC2 pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        // ID3D12Device12
        [PreserveSig]
        new D3D12_RESOURCE_ALLOCATION_INFO GetResourceAllocationInfo3(uint visibleMask, int numResourceDescs, /* _In_reads_(numResourceDescs) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RESOURCE_DESC1[] pResourceDescs, /* _In_opt_count_(numResourceDescs) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] uint[] pNumCastableFormats, /* _In_opt_count_(numResourceDescs) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DXGI_FORMAT[] ppCastableFormats, /* _Out_writes_opt_(numResourceDescs) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RESOURCE_ALLOCATION_INFO1[] pResourceAllocationInfo1);
        
        // ID3D12Device13
        [PreserveSig]
        new HRESULT OpenExistingHeapFromAddress1(/* _In_ */ IntPtr pAddress, IntPtr size, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvHeap);
        
        // ID3D12Device14
        [PreserveSig]
        HRESULT CreateRootSignatureFromSubobjectInLibrary(/* _In_ */ uint nodeMask, /* _In_reads_(blobLengthInBytes) */ IntPtr pLibraryBlob, /* _In_ */ IntPtr blobLengthInBytes, /* _In_opt_ */ [MarshalAs(UnmanagedType.LPWStr)] string subobjectName, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvRootSignature);
    }
}
