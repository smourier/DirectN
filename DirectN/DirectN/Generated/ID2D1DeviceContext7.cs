...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext7 : ID2D1DeviceContext6
    {
        ...
        // ID2D1DeviceContext6
        [PreserveSig]
        new void BlendImage(/* _In_ */ ID2D1Image image, D2D1_BLEND_MODE blendMode, /* optional(D2D_POINT_2F) */ IntPtr targetOffset, /* optional(D2D_RECT_F) */ IntPtr imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
        ...
        [PreserveSig]
        void DrawPaintGlyphRun(D2D_POINT_2F baselineOrigin, /* _In_ */ ref DWRITE_GLYPH_RUN glyphRun, /* _In_opt_ */ ID2D1Brush defaultFillBrush, uint colorPaletteIndex, DWRITE_MEASURING_MODE measuringMode);
        
        [PreserveSig]
        void DrawGlyphRunWithColorSupport(D2D_POINT_2F baselineOrigin, /* _In_ */ ref DWRITE_GLYPH_RUN glyphRun, /* optional(DWRITE_GLYPH_RUN_DESCRIPTION) */ IntPtr glyphRunDescription, /* _In_opt_ */ ID2D1Brush foregroundBrush, /* _In_opt_ */ ID2D1SvgGlyphStyle svgGlyphStyle, uint colorPaletteIndex, DWRITE_MEASURING_MODE measuringMode, D2D1_COLOR_BITMAP_GLYPH_SNAP_OPTION bitmapSnapOption);
    }
}
