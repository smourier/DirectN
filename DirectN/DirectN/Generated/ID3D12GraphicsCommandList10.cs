...
namespace DirectN
{
    ...
    public partial interface ID3D12GraphicsCommandList10 : ID3D12GraphicsCommandList9
    {
        ...
        [PreserveSig]
        new void ResolveSubresourceRegion(/* _In_ */ ID3D12Resource pDstResource, /* _In_ */ uint DstSubresource, /* _In_ */ uint DstX, /* _In_ */ uint DstY, /* _In_ */ ID3D12Resource pSrcResource, /* _In_ */ uint SrcSubresource, /* optional(tagRECT) */ IntPtr pSrcRect, /* _In_ */ DXGI_FORMAT Format, /* _In_ */ D3D12_RESOLVE_MODE ResolveMode);
        ...
        [PreserveSig]
        new void BeginRenderPass(/* _In_ */ int NumRenderTargets, /* _In_reads_opt_(NumRenderTargets) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_RENDER_PASS_RENDER_TARGET_DESC[] pRenderTargets, /* optional(D3D12_RENDER_PASS_DEPTH_STENCIL_DESC) */ IntPtr pDepthStencil, D3D12_RENDER_PASS_FLAGS Flags);
        
        [PreserveSig]
        new void EndRenderPass();
        
        [PreserveSig]
        new void InitializeMetaCommand(/* _In_ */ ID3D12MetaCommand pMetaCommand, /* optional(void) */ IntPtr pInitializationParametersData, /* _In_ */ IntPtr InitializationParametersDataSizeInBytes);
        
        [PreserveSig]
        new void ExecuteMetaCommand(/* _In_ */ ID3D12MetaCommand pMetaCommand, /* optional(void) */ IntPtr pExecutionParametersData, /* _In_ */ IntPtr ExecutionParametersDataSizeInBytes);
        
        [PreserveSig]
        new void BuildRaytracingAccelerationStructure(/* _In_ */ ref D3D12_BUILD_RAYTRACING_ACCELERATION_STRUCTURE_DESC pDesc, /* _In_ */ int NumPostbuildInfoDescs, /* _In_reads_opt_(NumPostbuildInfoDescs) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC[] pPostbuildInfoDescs);
        
        [PreserveSig]
        new void EmitRaytracingAccelerationStructurePostbuildInfo(/* _In_ */ ref D3D12_RAYTRACING_ACCELERATION_STRUCTURE_POSTBUILD_INFO_DESC pDesc, /* _In_ */ int NumSourceAccelerationStructures, /* _In_reads_( NumSourceAccelerationStructures ) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_GPU_VIRTUAL_ADDRESS[] pSourceAccelerationStructureData);
        
        [PreserveSig]
        new void CopyRaytracingAccelerationStructure(/* _In_ */ ulong DestAccelerationStructureData, /* _In_ */ ulong SourceAccelerationStructureData, /* _In_ */ D3D12_RAYTRACING_ACCELERATION_STRUCTURE_COPY_MODE Mode);
        
        [PreserveSig]
        new void SetPipelineState1(/* _In_ */ ID3D12StateObject pStateObject);
        
        [PreserveSig]
        new void DispatchRays(/* _In_ */ ref D3D12_DISPATCH_RAYS_DESC pDesc);
        
        // ID3D12GraphicsCommandList5
        [PreserveSig]
        new void RSSetShadingRate(/* _In_ */ D3D12_SHADING_RATE baseShadingRate, /* _In_reads_opt_(D3D12_RS_SET_SHADING_RATE_COMBINER_COUNT) */ [MarshalAs(UnmanagedType.LPArray)] D3D12_SHADING_RATE_COMBINER[] combiners);
        
        [PreserveSig]
        new void RSSetShadingRateImage(/* _In_opt_ */ ID3D12Resource shadingRateImage);
        
        // ID3D12GraphicsCommandList6
        [PreserveSig]
        new void DispatchMesh(/* _In_ */ uint ThreadGroupCountX, /* _In_ */ uint ThreadGroupCountY, /* _In_ */ uint ThreadGroupCountZ);
        
        // ID3D12GraphicsCommandList7
        [PreserveSig]
        new void Barrier(int NumBarrierGroups, /* _In_reads_(NumBarrierGroups) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_BARRIER_GROUP[] pBarrierGroups);
        
        // ID3D12GraphicsCommandList8
        [PreserveSig]
        new void OMSetFrontAndBackStencilRef(/* _In_ */ uint FrontStencilRef, /* _In_ */ uint BackStencilRef);
        
        // ID3D12GraphicsCommandList9
        [PreserveSig]
        new void RSSetDepthBias(/* _In_ */ float DepthBias, /* _In_ */ float DepthBiasClamp, /* _In_ */ float SlopeScaledDepthBias);
        
        [PreserveSig]
        new void IASetIndexBufferStripCutValue(/* _In_ */ D3D12_INDEX_BUFFER_STRIP_CUT_VALUE IBStripCutValue);
        
        // ID3D12GraphicsCommandList10
        [PreserveSig]
        void SetProgram(/* _In_ */ ref D3D12_SET_PROGRAM_DESC pDesc);
        
        [PreserveSig]
        void DispatchGraph(/* _In_ */ ref D3D12_DISPATCH_GRAPH_DESC pDesc);
    }
}
