...
namespace DirectN
{
    ...
    public partial struct __struct_ksmedia_135__union_0
    {
        ...
        public __struct_ksmedia_135__union_0__struct_0 Timecode {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<__struct_ksmedia_135__union_0__struct_0>(__bits, 0, 32);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[516]; InteropRuntime.Set<__struct_ksmedia_135__union_0__struct_0>(value, __bits, 0, 32); } }
        ...
        public __struct_ksmedia_135__union_0__struct_1 RawAVC {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<__struct_ksmedia_135__union_0__struct_1>(__bits, 0, 4128);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[516]; InteropRuntime.Set<__struct_ksmedia_135__union_0__struct_1>(value, __bits, 0, 4128); } }
    }
}
