...
namespace DirectN
{
    ...
    public partial struct _D3DDDI_RESOURCEFLAGS2__union_0__struct_0
    {
        ...
        public byte[] __bits;
        public uint VideoEncoder => InteropRuntime.GetUInt32Bits(__bits, 0, 1);
        public uint UserMemory => InteropRuntime.GetUInt32Bits(__bits, 1, 1);
        public uint CrossAdapter => InteropRuntime.GetUInt32Bits(__bits, 2, 1);
        public uint IsDisplayable => InteropRuntime.GetUInt32Bits(__bits, 3, 1);
