...
namespace DirectN
{
    ...
    public partial interface IDWriteFactory3 : IDWriteFactory2
    {
        ...
        [PreserveSig]
        HRESULT CreateFontFaceReference(/* _In_z_ */ ref char filePath, /* optional(FILETIME) */ IntPtr lastWriteTime, uint faceIndex, DWRITE_FONT_SIMULATIONS fontSimulations, /* _COM_Outptr_ */ out IDWriteFontFaceReference fontFaceReference);
