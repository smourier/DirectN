// c:\program files (x86)\windows kits\10\include\10.0.17763.0\shared\dxgi.h(1424,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDXGIOutput : IDXGIObject
    {
        ...
        [PreserveSig]
        HRESULT GetDisplayModeList(/* [in] */ DXGI_FORMAT EnumFormat, /* [in] */ uint Flags, /* [annotation][out][in] _Inout_ */ ref uint pNumModes, /* [annotation][out] _Out_writes_to_opt_(*pNumModes,*pNumModes) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DXGI_MODE_DESC[] pDesc);
