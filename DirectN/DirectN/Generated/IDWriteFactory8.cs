...
namespace DirectN
{
    ...
    public partial interface IDWriteFactory8 : IDWriteFactory7
    {
        ...
        // IDWriteFactory7
        [PreserveSig]
        new HRESULT GetSystemFontSet(bool includeDownloadableFonts, /* _COM_Outptr_ */ out IDWriteFontSet2 fontSet);
        
        [PreserveSig]
        new HRESULT GetSystemFontCollection(bool includeDownloadableFonts, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, /* _COM_Outptr_ */ out IDWriteFontCollection3 fontCollection);
        
        // IDWriteFactory8
        [PreserveSig]
        HRESULT TranslateColorGlyphRun(D2D_POINT_2F baselineOrigin, /* _In_ */ ref DWRITE_GLYPH_RUN glyphRun, /* optional(DWRITE_GLYPH_RUN_DESCRIPTION) */ IntPtr glyphRunDescription, DWRITE_GLYPH_IMAGE_FORMATS desiredGlyphImageFormats, DWRITE_PAINT_FEATURE_LEVEL paintFeatureLevel, DWRITE_MEASURING_MODE measuringMode, /* optional(DWRITE_MATRIX) */ IntPtr worldAndDpiTransform, uint colorPaletteIndex, /* _COM_Outptr_ */ out IDWriteColorGlyphRunEnumerator1 colorEnumerator);
    }
}
