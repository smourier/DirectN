...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT Lock2D(/* [annotation][out] _Outptr_result_bytebuffer_(_Inexpressible_(ComputePlaneSize(*plPitch))) */ out IntPtr ppbScanline0, /* [annotation][out] _Out_ */ out int plPitch);
