...
namespace DirectN
{
    ...
    public partial interface ID3D11VideoContext2 : ID3D11VideoContext1
    {
        ...
        // ID3D11VideoContext2
        [PreserveSig]
        void VideoProcessorSetOutputHDRMetaData(/* [annotation] _In_ */ ID3D11VideoProcessor pVideoProcessor, /* [annotation] _In_ */ DXGI_HDR_METADATA_TYPE Type, /* [annotation] _In_ */ uint Size, /* [annotation] _In_reads_bytes_opt_(Size) */ out IntPtr pHDRMetaData);
        
        [PreserveSig]
        void VideoProcessorGetOutputHDRMetaData(/* [annotation] _In_ */ ID3D11VideoProcessor pVideoProcessor, /* [annotation] _Out_ */ out DXGI_HDR_METADATA_TYPE pType, /* [annotation] _In_ */ uint Size, /* [annotation] _Out_writes_bytes_opt_(Size) */ out IntPtr pMetaData);
        
        [PreserveSig]
        void VideoProcessorSetStreamHDRMetaData(/* [annotation] _In_ */ ID3D11VideoProcessor pVideoProcessor, /* [annotation] _In_ */ uint StreamIndex, /* [annotation] _In_ */ DXGI_HDR_METADATA_TYPE Type, /* [annotation] _In_ */ uint Size, /* [annotation] _In_reads_bytes_opt_(Size) */ out IntPtr pHDRMetaData);
        
        [PreserveSig]
        void VideoProcessorGetStreamHDRMetaData(/* [annotation] _In_ */ ID3D11VideoProcessor pVideoProcessor, /* [annotation] _In_ */ uint StreamIndex, /* [annotation] _Out_ */ out DXGI_HDR_METADATA_TYPE pType, /* [annotation] _In_ */ uint Size, /* [annotation] _Out_writes_bytes_opt_(Size) */ out IntPtr pMetaData);
    }
}
