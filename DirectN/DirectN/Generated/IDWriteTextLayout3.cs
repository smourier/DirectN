// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\dwrite_3.h(1729,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDWriteTextLayout3 : IDWriteTextLayout2
    {
        ...
        [PreserveSig]
        HRESULT GetLineMetrics(/* _Out_writes_to_opt_(maxLineCount, *actualLineCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_LINE_METRICS1[] lineMetrics, int maxLineCount, /* _Out_ */ out uint actualLineCount);
    }
}
