// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d10.h(4444,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("9b7e4c10-342c-4106-a19f-4f2704f689f0"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D10Predicate : ID3D10Query
    {
        ...
        [PreserveSig]
        new HRESULT GetData(/* [annotation] _Out_writes_bytes_opt_(DataSize) */ [MarshalAs(UnmanagedType.IUnknown)] out object pData, /* [annotation] _In_ */ uint DataSize, /* [annotation] _In_ */ uint GetDataFlags);
