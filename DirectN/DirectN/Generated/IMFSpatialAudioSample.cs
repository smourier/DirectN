// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\mfspatialaudio.h(259,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFSpatialAudioSample : IMFSample
    {
        ...
        // IMFSample
        [PreserveSig]
        new HRESULT GetSampleFlags(/* [annotation][out] _Out_ */ out uint pdwSampleFlags);
        
        [PreserveSig]
        new HRESULT SetSampleFlags(/* [in] */ uint dwSampleFlags);
        
        [PreserveSig]
        new HRESULT GetSampleTime(/* [annotation][out] _Out_ */ out long phnsSampleTime);
        
        [PreserveSig]
        new HRESULT SetSampleTime(/* [in] */ long hnsSampleTime);
        
        [PreserveSig]
        new HRESULT GetSampleDuration(/* [annotation][out] _Out_ */ out long phnsSampleDuration);
        
        [PreserveSig]
        new HRESULT SetSampleDuration(/* [in] */ long hnsSampleDuration);
        
        [PreserveSig]
        new HRESULT GetBufferCount(/* [annotation][out] _Out_ */ out uint pdwBufferCount);
        
        [PreserveSig]
        new HRESULT GetBufferByIndex(/* [in] */ uint dwIndex, /* [annotation][out] _Out_ */ out IMFMediaBuffer ppBuffer);
        
        [PreserveSig]
        new HRESULT ConvertToContiguousBuffer(/* [annotation][out] _Out_ */ out IMFMediaBuffer ppBuffer);
        
        [PreserveSig]
        new HRESULT AddBuffer(/* [in] */ IMFMediaBuffer pBuffer);
        
        [PreserveSig]
        new HRESULT RemoveBufferByIndex(/* [in] */ uint dwIndex);
        
        [PreserveSig]
        new HRESULT RemoveAllBuffers();
        
        [PreserveSig]
        new HRESULT GetTotalLength(/* [annotation][out] _Out_ */ out uint pcbTotalLength);
        
        [PreserveSig]
        new HRESULT CopyToBuffer(/* [in] */ IMFMediaBuffer pBuffer);
