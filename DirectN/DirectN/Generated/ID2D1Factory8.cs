...
namespace DirectN
{
    ...
    public partial interface ID2D1Factory8 : ID2D1Factory7
    {
        ...
        [PreserveSig]
        new HRESULT CreateStrokeStyle(/* _In_ */ ref D2D1_STROKE_STYLE_PROPERTIES1 strokeStyleProperties, /* _In_reads_opt_(dashesCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] float[] dashes, int dashesCount, /* _COM_Outptr_ */ out ID2D1StrokeStyle1 strokeStyle);
        ...
        [PreserveSig]
        new HRESULT RegisterEffectFromStream(/* _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid classId, /* _In_ */ IStream propertyXml, /* _In_reads_opt_(bindingsCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] D2D1_PROPERTY_BINDING[] bindings, int bindingsCount, /* _In_ */ PD2D1_EFFECT_FACTORY effectFactory);
        ...
        [PreserveSig]
        new HRESULT GetRegisteredEffects(/* _Out_writes_to_opt_(effectsCount, *effectsReturned) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] Guid[] effects, int effectsCount, /* optional(UINT32) */ IntPtr effectsReturned, /* optional(UINT32) */ IntPtr effectsRegistered);
        ...
        // ID2D1Factory7
        [PreserveSig]
        new HRESULT CreateDevice(/* _In_ */ IDXGIDevice dxgiDevice, /* _COM_Outptr_ */ out ID2D1Device6 d2dDevice6);
        
        // ID2D1Factory8
        [PreserveSig]
        HRESULT CreateDevice(/* _In_ */ IDXGIDevice dxgiDevice, /* _COM_Outptr_ */ out ID2D1Device7 d2dDevice6);
    }
}
