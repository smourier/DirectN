...
namespace DirectN
{
    ...
    public partial interface IDWriteLocalFontFileLoader : IDWriteFontFileLoader
    {
        ...
        [PreserveSig]
        HRESULT GetFilePathFromKey(/* _In_reads_bytes_(fontFileReferenceKeySize) */ [MarshalAs(UnmanagedType.IUnknown)] object fontFileReferenceKey, uint fontFileReferenceKeySize, /* _Out_writes_z_(filePathSize) */ [MarshalAs(UnmanagedType.LPWStr)] string filePath, uint filePathSize);
        
        [PreserveSig]
        HRESULT GetLastWriteTimeFromKey(/* _In_reads_bytes_(fontFileReferenceKeySize) */ [MarshalAs(UnmanagedType.IUnknown)] object fontFileReferenceKey, uint fontFileReferenceKeySize, /* _Out_ */ out long lastWriteTime);
    }
}
