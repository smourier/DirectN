// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d10effect.h(615,1)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("71417501-8df9-4e0a-a78a-255f9756baff"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D10EffectStringVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT GetStringArray(/* THIS_ _Out_writes_(Count) */ out IntPtr ppStrings, uint Offset, uint Count);
    }
}
