...
namespace DirectN
{
    ...
    public partial interface IDWriteFactory4 : IDWriteFactory3
    {
        ...
        [PreserveSig]
        HRESULT ComputeGlyphOrigins(ref DWRITE_GLYPH_RUN glyphRun, DWRITE_MEASURING_MODE measuringMode, D2D_POINT_2F baselineOrigin, /* optional(DWRITE_MATRIX) */ IntPtr worldAndDpiTransform, /* _Out_writes_(glyphRun->glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray)] D2D_POINT_2F[] glyphOrigins);
        
        [PreserveSig]
        HRESULT ComputeGlyphOrigins(ref DWRITE_GLYPH_RUN glyphRun, D2D_POINT_2F baselineOrigin, /* _Out_writes_(glyphRun->glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray)] D2D_POINT_2F[] glyphOrigins);
    }
}
