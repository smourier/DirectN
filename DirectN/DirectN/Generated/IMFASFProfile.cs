// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\wmcontainer.h(304,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("d267bf6a-028b-4e0d-903d-43f0ef82d0d4"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IMFASFProfile : IMFAttributes
    {
        ...
        [PreserveSig]
        new HRESULT GetBlob(/* __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidKey, /* [size_is][out] __RPC__out_ecount_full(cbBufSize) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] byte[] pBuf, uint cbBufSize, /* optional(UINT32) */ IntPtr pcbBlobSize);
        ...
        [PreserveSig]
        HRESULT GetStream(/* [in] */ uint dwStreamIndex, /* [out] */ out ushort pwStreamNumber, /* [out] */ out IMFASFStreamConfig ppIStream);
        
        [PreserveSig]
        HRESULT GetStreamByNumber(/* [in] */ ushort wStreamNumber, /* [out] */ out IMFASFStreamConfig ppIStream);
        
        [PreserveSig]
        HRESULT SetStream(/* [in] */ IMFASFStreamConfig pIStream);
        
        [PreserveSig]
        HRESULT RemoveStream(/* [in] */ ushort wStreamNumber);
        
        [PreserveSig]
        HRESULT CreateStream(/* [in] */ IMFMediaType pIMediaType, /* [out] */ out IMFASFStreamConfig ppIStream);
        
        [PreserveSig]
        HRESULT GetMutualExclusionCount(/* [out] */ out uint pcMutexs);
        
        [PreserveSig]
        HRESULT GetMutualExclusion(/* [in] */ uint dwMutexIndex, /* [out] */ out IMFASFMutualExclusion ppIMutex);
        
        [PreserveSig]
        HRESULT AddMutualExclusion(/* [in] */ IMFASFMutualExclusion pIMutex);
        
        [PreserveSig]
        HRESULT RemoveMutualExclusion(/* [in] */ uint dwMutexIndex);
        
        [PreserveSig]
        HRESULT CreateMutualExclusion(/* [out] */ out IMFASFMutualExclusion ppIMutex);
        
        [PreserveSig]
        HRESULT GetStreamPrioritization(/* [out] */ out IMFASFStreamPrioritization ppIStreamPrioritization);
        ...
        [PreserveSig]
        HRESULT CreateStreamPrioritization(/* [out] */ out IMFASFStreamPrioritization ppIStreamPrioritization);
        
        [PreserveSig]
        HRESULT Clone(/* [out] */ out IMFASFProfile ppIProfile);
    }
}
