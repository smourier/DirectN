...
namespace DirectN
{
    ...
    public partial interface IDxcCompiler2 : IDxcCompiler
    {
        ...
        // IDxcCompiler2
        [PreserveSig]
        HRESULT CompileWithDebug(/* _In_ */ IDxcBlob pSource, /* // Source text to compile _In_opt_ */ [MarshalAs(UnmanagedType.LPWStr)] string pSourceName, /* // Optional file name for pSource. Used in errors and include handlers. _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string pEntryPoint, /* // Entry point name _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string pTargetProfile, /* // Shader profile to compile _In_count_(argCount) */ out IntPtr pArguments, /* // Array of pointers to arguments _In_ */ uint argCount, /* // Number of arguments _In_count_(defineCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 7)] DxcDefine[] pDefines, /* // Array of defines _In_ */ uint defineCount, /* // Number of defines _In_opt_ */ IDxcIncludeHandler pIncludeHandler, /* // user-provided interface to handle #include directives (optional) _COM_Outptr_ */ out IDxcOperationResult[] ppResult, /* and errors _Outptr_opt_result_z_ */ out IntPtr ppDebugBlobName, /* // Suggested file name for debug blob. _COM_Outptr_opt_ */ out IDxcBlob ppDebugBlob);
    }
}
