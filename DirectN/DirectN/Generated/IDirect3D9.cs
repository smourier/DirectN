...
namespace DirectN
{
    ...
    public partial interface IDirect3D9
    {
        ...
        [PreserveSig]
        HRESULT GetAdapterIdentifier(uint Adapter, uint Flags, IntPtr pIdentifier);
        ...
        [PreserveSig]
        HRESULT CreateDevice(uint Adapter, _D3DDEVTYPE DeviceType, IntPtr hFocusWindow, uint BehaviorFlags, IntPtr pPresentationParameters, out IDirect3DDevice9 ppReturnedDeviceInterface);
    }
}
