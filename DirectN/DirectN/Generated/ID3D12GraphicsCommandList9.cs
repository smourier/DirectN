...
namespace DirectN
{
    ...
    public partial interface ID3D12GraphicsCommandList9 : ID3D12GraphicsCommandList8
    {
        ...
        [PreserveSig]
        void RSSetDepthBias(/* _In_ */ float DepthBias, /* _In_ */ float DepthBiasClamp, /* _In_ */ float SlopeScaledDepthBias);
        
        [PreserveSig]
        void IASetIndexBufferStripCutValue(/* _In_ */ D3D12_INDEX_BUFFER_STRIP_CUT_VALUE IBStripCutValue);
    }
}
