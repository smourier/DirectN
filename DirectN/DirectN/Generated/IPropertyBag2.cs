// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\ocidl.h(6032,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IPropertyBag2
    {
        ...
        [PreserveSig]
        HRESULT Write(/* [in] */ uint cProperties, /* [size_is][in] __RPC__in_ecount_full(cProperties) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] tagPROPBAG2[] pPropBag, /* [size_is][in] __RPC__in_ecount_full(cProperties) */ IntPtr pvarValue);
