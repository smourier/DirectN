// c:\program files (x86)\windows kits\10\include\10.0.19041.0\um\d3d12.h(8972,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12Device1 : ID3D12Device
    {
        ...
        [PreserveSig]
        HRESULT SetEventOnMultipleFenceCompletion(/* _In_reads_(NumFences) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ID3D12Fence[] ppFences, /* _In_reads_(NumFences) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ulong[] pFenceValues, int NumFences, D3D12_MULTIPLE_FENCE_WAIT_FLAGS Flags, IntPtr hEvent);
        
        [PreserveSig]
        HRESULT SetResidencyPriority(int NumObjects, /* _In_reads_(NumObjects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] ID3D12Pageable[] ppObjects, /* _In_reads_(NumObjects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_RESIDENCY_PRIORITY[] pPriorities);
    }
}
