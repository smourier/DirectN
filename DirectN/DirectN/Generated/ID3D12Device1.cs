// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d12.h(8788,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("77acce80-638e-4e65-8895-c1f23386863e"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D12Device1 : ID3D12Device
    {
        ...
        // ID3D12Device1
        [PreserveSig]
        HRESULT CreatePipelineLibrary(/* _In_reads_(BlobLength) */ out IntPtr pLibraryBlob, ulong BlobLength, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppPipelineLibrary);
        
        [PreserveSig]
        HRESULT SetEventOnMultipleFenceCompletion(/* _In_reads_(NumFences) */ out ID3D12Fence[] ppFences, /* _In_reads_(NumFences) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ulong[] pFenceValues, uint NumFences, D3D12_MULTIPLE_FENCE_WAIT_FLAGS Flags, IntPtr hEvent);
        
        [PreserveSig]
        HRESULT SetResidencyPriority(uint NumObjects, /* _In_reads_(NumObjects) */ out ID3D12Pageable[] ppObjects, /* _In_reads_(NumObjects) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_RESIDENCY_PRIORITY[] pPriorities);
    }
}
