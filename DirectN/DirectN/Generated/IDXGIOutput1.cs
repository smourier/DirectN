// c:\program files (x86)\windows kits\10\include\10.0.17763.0\shared\dxgi1_2.h(2173,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDXGIOutput1 : IDXGIOutput
    {
        ...
        // IDXGIOutput1
        [PreserveSig]
        HRESULT GetDisplayModeList1(/* [in] */ DXGI_FORMAT EnumFormat, /* [in] */ uint Flags, /* [annotation][out][in] _Inout_ */ ref uint pNumModes, /* [annotation][out] _Out_writes_to_opt_(*pNumModes,*pNumModes) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DXGI_MODE_DESC1[] pDesc);
        ...
        [PreserveSig]
        HRESULT DuplicateOutput(/* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.IUnknown)] object pDevice, /* [annotation][out] _COM_Outptr_ */ out IDXGIOutputDuplication ppOutputDuplication);
    }
}
