// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d12.h(8590,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("80eabf42-2568-4e5e-bd82-c37f86961dc3"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D12PipelineLibrary1 : ID3D12PipelineLibrary
    {
        ...
        [PreserveSig]
        new HRESULT Serialize(/* _Out_writes_(DataSizeInBytes) */ [MarshalAs(UnmanagedType.IUnknown)] out object pData, IntPtr DataSizeInBytes);
