...
namespace DirectN
{
    ...
    public partial struct _D3DKMT_QUERYSTATISTICS_SEGMENT_INFORMATION__struct_1
    {
        ...
        public ulong Reserved {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.GetUInt64(__bits, 6, 58);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[8]; InteropRuntime.SetUInt64(value, __bits, 6, 58); } }
    }
}
