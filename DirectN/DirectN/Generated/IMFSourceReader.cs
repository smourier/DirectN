...
namespace DirectN
{
    ...
    public partial interface IMFSourceReader
    {
        ...
        [PreserveSig]
        HRESULT GetNativeMediaType(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][in] _In_ */ uint dwMediaTypeIndex, /* [annotation][out] _Out_ */ out IntPtr ppMediaType);
        
        [PreserveSig]
        HRESULT GetCurrentMediaType(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][out] _Out_ */ out IntPtr ppMediaType);
        
        [PreserveSig]
        HRESULT SetCurrentMediaType(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][out][in] _Reserved_ */ ref uint pdwReserved, /* [annotation][in] _In_ */ ref IMFMediaType pMediaType);
        ...
        [PreserveSig]
        HRESULT ReadSample(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][in] _In_ */ uint dwControlFlags, /* [annotation][out] _Out_opt_ */ out uint pdwActualStreamIndex, /* [annotation][out] _Out_opt_ */ out uint pdwStreamFlags, /* [annotation][out] _Out_opt_ */ out long pllTimestamp, /* optional(IMFSample) */ out IntPtr ppSample);
