...
namespace DirectN
{
    ...
    public partial struct _DXGK_PRESENTMULTIPLANEOVERLAYLIST__struct_0
    {
        ...
        public byte[] __bits;
        public uint SegmentId {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.GetUInt32(__bits, 0, 5);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[4]; InteropRuntime.SetUInt32(value, __bits, 0, 5); } }
