// c:\program files (x86)\windows kits\10\include\10.0.22000.0\shared\dxgi1_3.h(139,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDXGIDevice3 : IDXGIDevice2
    {
        ...
        [PreserveSig]
        new HRESULT CreateSurface(/* [annotation][in] _In_ */ ref DXGI_SURFACE_DESC pDesc, /* [in] */ uint NumSurfaces, /* [in] */ uint Usage, /* optional(DXGI_SHARED_RESOURCE) */ IntPtr pSharedResource, /* [annotation][size_is][out] _Out_writes_(NumSurfaces) */ IntPtr ppSurface);
