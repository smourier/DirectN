...
namespace DirectN
{
    ...
    public partial struct __struct_ksmedia_283__union_0
    {
        ...
        public __struct_ksmedia_283__union_0__struct_0 Timecode { get => InteropRuntime.Get<__struct_ksmedia_283__union_0__struct_0>(__bits, 0, 32); set { if (__bits == null) __bits = new byte[1024]; InteropRuntime.Set<__struct_ksmedia_283__union_0__struct_0>(value, __bits, 0, 32); } }
        ...
        public __struct_ksmedia_283__union_0__struct_1 RawAVC { get => InteropRuntime.Get<__struct_ksmedia_283__union_0__struct_1>(__bits, 0, 8192); set { if (__bits == null) __bits = new byte[1024]; InteropRuntime.Set<__struct_ksmedia_283__union_0__struct_1>(value, __bits, 0, 8192); } }
    }
}
