// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3dumddi.h(35,9)
using System;
...
namespace DirectN
{
    ...
    public partial struct _D3DDDI_PRESENTFLAGS__union_0__struct_0
    {
        ...
        public uint AllowTearing { get => InteropRuntime.GetUInt32(__bits, 3, 1); set { if (__bits == null) __bits = new byte[4]; InteropRuntime.SetUInt32(value, __bits, 3, 1); } }
        public uint AllowFlexibleRefresh { get => InteropRuntime.GetUInt32(__bits, 4, 1); set { if (__bits == null) __bits = new byte[4]; InteropRuntime.SetUInt32(value, __bits, 4, 1); } }
