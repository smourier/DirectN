...
namespace DirectN
{
    [ComImport, Guid("92d43d0f-54a8-4bae-96da-356d259a5c26"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IMFCameraControlDefaultsCollection : IMFAttributes
    {
        ...
        [PreserveSig]
        HRESULT GetControl(/* [annotation][in] _In_ */ uint index, /* [annotation][out] _COM_Outptr_ */ out IMFCameraControlDefaults configuration);
        
        [PreserveSig]
        HRESULT GetOrAddExtendedControl(/* [annotation][in] _In_ */ __MIDL___MIDL_itf_mfidl_0000_0136_0001 configType, /* [annotation][in] _In_ */ uint constrolId, /* [annotation][in] _In_ */ uint streamId, /* [annotation][in] _In_ */ uint dataSize, /* [annotation][out] _COM_Outptr_ */ out IMFCameraControlDefaults defaults);
        
        [PreserveSig]
        HRESULT GetOrAddControl(/* [annotation][in] _In_ */ __MIDL___MIDL_itf_mfidl_0000_0136_0001 configType, /* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid controlSet, /* [annotation][in] _In_ */ uint constrolId, /* [annotation][in] _In_ */ uint controlSize, /* [annotation][in] _In_ */ uint dataSize, /* [annotation][out] _COM_Outptr_ */ out IMFCameraControlDefaults defaults);
        
        [PreserveSig]
        HRESULT RemoveControl(/* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid controlSet, /* [annotation][in] _In_ */ uint constrolId);
