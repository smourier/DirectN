...
namespace DirectN
{
    ...
    public partial struct _DXGK_VALIDATESUBMITCOMMANDFLAGS__union_0
    {
        ...
        public byte[] __bits;
        public _DXGK_VALIDATESUBMITCOMMANDFLAGS__union_0__struct_0 __field_0 { get => InteropRuntime.Get<_DXGK_VALIDATESUBMITCOMMANDFLAGS__union_0__struct_0>(__bits, 0, 32); set => InteropRuntime.Set<_DXGK_VALIDATESUBMITCOMMANDFLAGS__union_0__struct_0>(value, __bits, 0, 32); }
