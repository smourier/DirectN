// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d10effect.h(668,1)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [ComImport, Guid("c0a7157b-d872-4b1d-8073-efc2acd4b1fc"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D10EffectShaderResourceVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT SetResourceArray(/* THIS_ _In_reads_(Count) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ID3D10ShaderResourceView[] ppResources, uint Offset, int Count);
        
        [PreserveSig]
        HRESULT GetResourceArray(/* THIS_ _Out_writes_(Count) */ IntPtr ppResources, uint Offset, uint Count);
    }
}
