...
namespace DirectN
{
    ...
    public partial interface ID3D10EffectShaderResourceVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT SetResourceArray(/* THIS_ _In_reads_(Count) */ out ID3D10ShaderResourceView[] ppResources, uint Offset, uint Count);
        
        [PreserveSig]
        HRESULT GetResourceArray(/* THIS_ _Out_writes_(Count) */ out ID3D10ShaderResourceView[] ppResources, uint Offset, uint Count);
    }
}
