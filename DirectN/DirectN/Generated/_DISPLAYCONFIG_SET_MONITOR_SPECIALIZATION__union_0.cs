...
namespace DirectN
{
    ...
    public partial struct _DISPLAYCONFIG_SET_MONITOR_SPECIALIZATION__union_0
    {
        ...
        public byte[] __bits;
        public _DISPLAYCONFIG_SET_MONITOR_SPECIALIZATION__union_0__struct_0 __field_0 {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<_DISPLAYCONFIG_SET_MONITOR_SPECIALIZATION__union_0__struct_0>(__bits, 0, 32);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[4]; InteropRuntime.Set<_DISPLAYCONFIG_SET_MONITOR_SPECIALIZATION__union_0__struct_0>(value, __bits, 0, 32); } }
