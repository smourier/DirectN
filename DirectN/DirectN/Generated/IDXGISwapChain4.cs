// c:\program files (x86)\windows kits\10\include\10.0.18362.0\shared\dxgi1_5.h(459,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDXGISwapChain4 : IDXGISwapChain3
    {
        ...
        [PreserveSig]
        new HRESULT CheckColorSpaceSupport(/* [annotation][in] _In_ */ DXGI_COLOR_SPACE_TYPE ColorSpace, /* [annotation][out] _Out_ */ out uint pColorSpaceSupport);
        ...
        // IDXGISwapChain4
        [PreserveSig]
        HRESULT SetHDRMetaData(/* [annotation][in] _In_ */ DXGI_HDR_METADATA_TYPE Type, /* [annotation][in] _In_ */ uint Size, /* optional(void) */ IntPtr pMetaData);
    }
}
