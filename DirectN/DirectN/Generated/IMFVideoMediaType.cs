// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfobjects.h(2905,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFVideoMediaType : IMFMediaType
    {
        ...
        [PreserveSig]
        HRESULT GetVideoRepresentation(/* [in] */ Guid guidRepresentation, /* [annotation][out] _Out_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvRepresentation, /* [in] */ int lStride);
    }
}
