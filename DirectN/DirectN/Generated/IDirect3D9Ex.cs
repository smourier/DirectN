// c:\program files (x86)\windows kits\10\include\10.0.22000.0\shared\d3d9.h(204,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDirect3D9Ex : IDirect3D9
    {
        ...
        [PreserveSig]
        new HRESULT GetAdapterIdentifier(uint Adapter, uint Flags, /*ref _D3DADAPTER_IDENTIFIER9*/ IntPtr pIdentifier);
        ...
        [PreserveSig]
        new HRESULT CreateDevice(uint Adapter, _D3DDEVTYPE DeviceType, IntPtr hFocusWindow, uint BehaviorFlags, /*ref _D3DPRESENT_PARAMETERS_*/ IntPtr pPresentationParameters, out IDirect3DDevice9 ppReturnedDeviceInterface);
        ...
        [PreserveSig]
        HRESULT CreateDeviceEx(uint Adapter, _D3DDEVTYPE DeviceType, IntPtr hFocusWindow, uint BehaviorFlags, /* ref _D3DPRESENT_PARAMETERS_*/ IntPtr pPresentationParameters, IntPtr pFullscreenDisplayMode, out IDirect3DDevice9Ex ppReturnedDeviceInterface);
