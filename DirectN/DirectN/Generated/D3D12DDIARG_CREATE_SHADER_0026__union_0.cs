// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12umddi.h(5471,5)
using System;
...
namespace DirectN
{
    ...
    public partial struct D3D12DDIARG_CREATE_SHADER_0026__union_0
    {
        ...
        public IntPtr Mesh { get => InteropRuntime.Get<IntPtr>(__bits, 0, IntPtr.Size); set { if (__bits == null) __bits = new byte[72]; InteropRuntime.Set<IntPtr>(value, __bits, 0, IntPtr.Size); } }
    }
}
