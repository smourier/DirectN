// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d11on12.h(167,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D11On12Device
    {
        ...
        [PreserveSig]
        void ReleaseWrappedResources(/* _In_reads_( NumResources ) */ out ID3D11Resource[] ppResources, uint NumResources);
        
        [PreserveSig]
        void AcquireWrappedResources(/* _In_reads_( NumResources ) */ out ID3D11Resource[] ppResources, uint NumResources);
    }
}
