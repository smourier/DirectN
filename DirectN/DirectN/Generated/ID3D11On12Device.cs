...
namespace DirectN
{
    ...
    public partial interface ID3D11On12Device
    {
        ...
        [PreserveSig]
        void ReleaseWrappedResources(/* _In_reads_( NumResources ) */ out IntPtr ppResources, uint NumResources);
        
        [PreserveSig]
        void AcquireWrappedResources(/* _In_reads_( NumResources ) */ out IntPtr ppResources, uint NumResources);
    }
}
