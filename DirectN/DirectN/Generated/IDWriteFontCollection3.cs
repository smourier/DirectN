// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\dwrite_3.h(3509,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDWriteFontCollection3 : IDWriteFontCollection2
    {
        ...
        [PreserveSig]
        new HRESULT GetMatchingFonts(/* _In_z_ */ [MarshalAs(UnmanagedType.LPWStr)] string familyName, /* _In_reads_(fontAxisValueCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, /* _COM_Outptr_ */ out IDWriteFontList2 fontList);
