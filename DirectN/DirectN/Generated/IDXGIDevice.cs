...
namespace DirectN
{
    ...
    public partial interface IDXGIDevice : IDXGIObject
    {
        ...
        [PreserveSig]
        HRESULT CreateSurface(/* [annotation][in] _In_ */ ref DXGI_SURFACE_DESC pDesc, /* [in] */ uint NumSurfaces, /* [in] */ uint Usage, /* optional(DXGI_SHARED_RESOURCE) */ IntPtr pSharedResource, /* [annotation][size_is][out] _Out_writes_(NumSurfaces) */ out IntPtr ppSurface);
