// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\dwrite_1.h(1760,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDWriteTextAnalysisSink1 : IDWriteTextAnalysisSink
    {
        ...
        [PreserveSig]
        new HRESULT SetLineBreakpoints(uint textPosition, uint textLength, /* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_LINE_BREAKPOINT[] lineBreakpoints);
