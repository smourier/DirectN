...
namespace DirectN
{
    ...
    public partial struct D3D10DDIARG_CREATESHADERRESOURCEVIEW__union_0
    {
        ...
        public D3D10DDIARG_TEXCUBE_SHADERRESOURCEVIEW TexCube {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<D3D10DDIARG_TEXCUBE_SHADERRESOURCEVIEW>(__bits, 0, 64);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[16]; InteropRuntime.Set<D3D10DDIARG_TEXCUBE_SHADERRESOURCEVIEW>(value, __bits, 0, 64); } }
    }
}
