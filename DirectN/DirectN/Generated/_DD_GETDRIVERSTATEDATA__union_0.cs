// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\ddrawint.h(1977,5)
using System;
...
namespace DirectN
{
    ...
    public partial struct _DD_GETDRIVERSTATEDATA__union_0
    {
        ...
        public IntPtr dwhContext { get => InteropRuntime.Get<IntPtr>(__bits, 0, IntPtr.Size); set => InteropRuntime.Set<IntPtr>(value, __bits, 0, IntPtr.Size); }
    }
}
