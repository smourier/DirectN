...
namespace DirectN
{
    ...
    public partial interface IAudioClient3 : IAudioClient2
    {
        ...
        [PreserveSig]
        new HRESULT GetBufferSizeLimits(/* [annotation][in] _In_ */ ref tWAVEFORMATEX pFormat, /* [annotation][in] _In_ */ bool bEventDriven, /* [annotation][out] _Out_ */ out long phnsMinBufferDuration, /* [annotation][out] _Out_ */ out long phnsMaxBufferDuration);
        ...
        [PreserveSig]
        HRESULT GetCurrentSharedModeEnginePeriod(/* [unique][annotation][out] _Out_ */ out tWAVEFORMATEX ppFormat, /* [annotation][out] _Out_ */ out uint pCurrentPeriodInFrames);
        
        [PreserveSig]
        HRESULT InitializeSharedAudioStream(/* [annotation][in] _In_ */ uint StreamFlags, /* [annotation][in] _In_ */ uint PeriodInFrames, /* [annotation][in] _In_ */ ref tWAVEFORMATEX pFormat, /* [annotation][in] _In_opt_ */ Guid AudioSessionGuid);
    }
}
