...
namespace DirectN
{
    ...
    public partial interface IDWriteTextAnalyzer2 : IDWriteTextAnalyzer1
    {
        ...
        [PreserveSig]
        new HRESULT GetTextComplexity(/* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPWStr)] string textString, uint textLength, /* _In_ */ IDWriteFontFace fontFace, /* _Out_ */ out bool isTextSimple, /* _Out_range_(0, textLength) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] uint[] textLengthRead, /* _Out_writes_to_opt_(textLength, *textLengthRead) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ushort[] glyphIndices);
        ...
        [PreserveSig]
        HRESULT GetTypographicFeatures(ref IDWriteFontFace fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* _In_opt_z_ */ [MarshalAs(UnmanagedType.LPWStr)] string localeName, uint maxTagCount, /* _Out_ */ out uint actualTagCount, /* _Out_writes_(maxTagCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] DWRITE_FONT_FEATURE_TAG tags);
        
        [PreserveSig]
        HRESULT CheckTypographicFeature(ref IDWriteFontFace fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* _In_opt_z_ */ [MarshalAs(UnmanagedType.LPWStr)] string localeName, DWRITE_FONT_FEATURE_TAG featureTag, uint glyphCount, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] ushort[] glyphIndices, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] byte[] featureApplies);
    }
}
