...
namespace DirectN
{
    ...
    public partial interface IDWriteTextAnalyzer2 : IDWriteTextAnalyzer1
    {
        ...
        [PreserveSig]
        new HRESULT GetGlyphs(/* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] char[] textString, uint textLength, /* _In_ */ IDWriteFontFace fontFace, bool isSideways, bool isRightToLeft, /* _In_ */ ref DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, /* _In_opt_ */ IDWriteNumberSubstitution numberSubstitution, /* optional(DWRITE_TYPOGRAPHIC_FEATURES) */ out IntPtr features, /* _In_reads_opt_(featureRanges) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 10)] uint[] featureRangeLengths, uint featureRanges, uint maxGlyphCount, /* _Out_writes_(textLength) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ushort[] clusterMap, /* _Out_writes_(textLength) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, /* _Out_writes_(maxGlyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 11)] ushort[] glyphIndices, /* _Out_writes_(maxGlyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 11)] DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, /* _Out_ */ out uint actualGlyphCount);
        
        [PreserveSig]
        new HRESULT GetGlyphPlacements(/* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] char[] textString, /* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] ushort[] clusterMap, /* _Inout_updates_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, uint textLength, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] ushort[] glyphIndices, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, uint glyphCount, /* _In_ */ IDWriteFontFace fontFace, float fontEmSize, bool isSideways, bool isRightToLeft, /* _In_ */ ref DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, /* optional(DWRITE_TYPOGRAPHIC_FEATURES) */ out IntPtr features, /* _In_reads_opt_(featureRanges) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 15)] uint[] featureRangeLengths, uint featureRanges, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] float[] glyphAdvances, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] DWRITE_GLYPH_OFFSET[] glyphOffsets);
        
        [PreserveSig]
        new HRESULT GetGdiCompatibleGlyphPlacements(/* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] char[] textString, /* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] ushort[] clusterMap, /* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] DWRITE_SHAPING_TEXT_PROPERTIES[] textProps, uint textLength, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] ushort[] glyphIndices, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProps, uint glyphCount, /* _In_ */ IDWriteFontFace fontFace, float fontEmSize, float pixelsPerDip, /* optional(DWRITE_MATRIX) */ IntPtr transform, bool useGdiNatural, bool isSideways, bool isRightToLeft, /* _In_ */ ref DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, /* optional(DWRITE_TYPOGRAPHIC_FEATURES) */ out IntPtr features, /* _In_reads_opt_(featureRanges) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 18)] uint[] featureRangeLengths, uint featureRanges, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] float[] glyphAdvances, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 6)] DWRITE_GLYPH_OFFSET[] glyphOffsets);
        
        // IDWriteTextAnalyzer1
        [PreserveSig]
        new HRESULT ApplyCharacterSpacing(float leadingSpacing, float trailingSpacing, float minimumAdvanceWidth, uint textLength, uint glyphCount, /* _In_reads_(textLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] ushort[] clusterMap, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] float[] glyphAdvances, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] DWRITE_GLYPH_OFFSET[] glyphOffsets, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] DWRITE_SHAPING_GLYPH_PROPERTIES[] glyphProperties, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] float[] modifiedGlyphAdvances, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] DWRITE_GLYPH_OFFSET[] modifiedGlyphOffsets);
        
        [PreserveSig]
        new HRESULT GetBaseline(/* _In_ */ IDWriteFontFace fontFace, DWRITE_BASELINE baseline, bool isVertical, bool isSimulationAllowed, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, /* _Out_ */ out int baselineCoordinate, /* _Out_ */ out bool exists);
        ...
        [PreserveSig]
        HRESULT GetTypographicFeatures(IDWriteFontFace fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, uint maxTagCount, /* _Out_ */ out uint actualTagCount, /* _Out_writes_(maxTagCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] DWRITE_FONT_FEATURE_TAG tags);
        
        [PreserveSig]
        HRESULT CheckTypographicFeature(IDWriteFontFace fontFace, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, DWRITE_FONT_FEATURE_TAG featureTag, uint glyphCount, /* _In_reads_(glyphCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] ushort[] glyphIndices, /* _Out_writes_(glyphCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] byte[] featureApplies);
    }
}
