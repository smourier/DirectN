...
namespace DirectN
{
    ...
    public partial interface ID3D12Device5 : ID3D12Device4
    {
        ...
        [PreserveSig]
        new HRESULT EnqueueMakeResident(D3D12_RESIDENCY_FLAGS Flags, uint NumObjects, /* _In_reads_(NumObjects) */ out IntPtr ppObjects, /* _In_ */ ID3D12Fence pFenceToSignal, ulong FenceValueToSignal);
        ...
        [PreserveSig]
        HRESULT EnumerateMetaCommands(/* _Inout_ */ ref uint pNumMetaCommands, /* _Out_writes_opt_(*pNumMetaCommands) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_META_COMMAND_DESC[] pDescs);
