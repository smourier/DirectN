// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12.h(13378,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12Device5 : ID3D12Device4
    {
        ...
        [PreserveSig]
        HRESULT EnumerateMetaCommands(/* _Inout_ */ ref int pNumMetaCommands, /* _Out_writes_opt_(*pNumMetaCommands) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_META_COMMAND_DESC[] pDescs);
