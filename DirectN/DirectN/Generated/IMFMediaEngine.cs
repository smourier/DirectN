...
namespace DirectN
{
    ...
    public partial interface IMFMediaEngine
    {
        ...
        [PreserveSig]
        HRESULT TransferVideoFrame(/* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.IUnknown)] object pDstSurf, /* [annotation][in] _In_opt_ */ ref MFVideoNormalizedRect pSrc, /* [annotation][in] _In_ */ ref tagRECT pDst, /* [annotation][in] _In_opt_ */ ref _MFARGB pBorderClr);
