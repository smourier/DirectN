...
namespace DirectN
{
    ...
    public partial struct _DXGK_DEVICE_TYPE_CAPS__union_0__struct_0
    {
        ...
        public byte[] __bits;
        public uint Discrete {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.GetUInt32(__bits, 0, 1);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[4]; InteropRuntime.SetUInt32(value, __bits, 0, 1); } }
