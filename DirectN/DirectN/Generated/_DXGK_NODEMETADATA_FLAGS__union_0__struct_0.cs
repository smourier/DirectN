// c:\program files (x86)\windows kits\10\include\10.0.22621.0\shared\d3dkmdt.h(1965,9)
using System;
...
namespace DirectN
{
    ...
    public partial struct _DXGK_NODEMETADATA_FLAGS__union_0__struct_0
    {
        ...
        public uint UserModeSubmission { get => InteropRuntime.GetUInt32(__bits, 3, 1); set { if (__bits == null) __bits = new byte[4]; InteropRuntime.SetUInt32(value, __bits, 3, 1); } }
