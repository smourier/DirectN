// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d2d1effects.h(1429,9)
namespace DirectN
{
    /// <summary>
    /// The enumeration of the Gamma Transfer effect's top level properties. Effect description: Remaps the color intensities of the input bitmap based on a user specified gamma transfer function for each RGBA channel.
    /// </summary>
