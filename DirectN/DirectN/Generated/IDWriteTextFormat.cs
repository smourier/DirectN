// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\dwrite.h(2049,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDWriteTextFormat
    {
        ...
        [PreserveSig]
        HRESULT GetFontFamilyName(/* _Out_writes_z_(nameSize) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] char[] fontFamilyName, uint nameSize);
        ...
        [PreserveSig]
        HRESULT GetLocaleName(/* _Out_writes_z_(nameSize) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] char[] localeName, uint nameSize);
    }
}
