// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfidl.h(8622,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFSampleGrabberSinkCallback : IMFClockStateSink
    {
        ...
        [PreserveSig]
        HRESULT OnProcessSample(/* [in] */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidMajorMediaType, /* [in] */ uint dwSampleFlags, /* [in] */ long llSampleTime, /* [in] */ long llSampleDuration, /* [annotation][in] _In_reads_bytes_(dwSampleSize) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] byte[] pSampleBuffer, /* [in] */ uint dwSampleSize);
