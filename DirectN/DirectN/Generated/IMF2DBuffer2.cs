...
namespace DirectN
{
    ...
    public partial interface IMF2DBuffer2 : IMF2DBuffer
    {
        // IMF2DBuffer
        [PreserveSig]
        new HRESULT Lock2D(/* [annotation][out] _Outptr_result_bytebuffer_(_Inexpressible_(ComputePlaneSize(*plPitch))) */ out IntPtr ppbScanline0, /* [annotation][out] _Out_ */ out int plPitch);
        ...
        // IMF2DBuffer2
        [PreserveSig]
        HRESULT Lock2DSize(/* [annotation][in] _In_ */ _MF2DBuffer_LockFlags lockFlags, /* [annotation][out] _Outptr_result_bytebuffer_(_Inexpressible_(ComputePlaneSize(*plPitch))) */ out IntPtr ppbScanline0, /* [annotation][out] _Out_ */ out int plPitch, /* [annotation][out] _Outptr_result_bytebuffer_(*pcbBufferLength) */ out IntPtr ppbBufferStart, /* [annotation][out] _Out_ */ out uint pcbBufferLength);
