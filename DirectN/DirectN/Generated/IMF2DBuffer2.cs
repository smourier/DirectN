// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\mfobjects.h(1522,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMF2DBuffer2 : IMF2DBuffer
    {
        ...
        [PreserveSig]
        new HRESULT ContiguousCopyTo(/* [annotation][size_is][out] _Out_writes_bytes_(cbDestBuffer) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pbDestBuffer, /* [in] */ uint cbDestBuffer);
        
        [PreserveSig]
        new HRESULT ContiguousCopyFrom(/* [annotation][size_is][in] _In_reads_bytes_(cbSrcBuffer) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pbSrcBuffer, /* [in] */ uint cbSrcBuffer);
