...
namespace DirectN
{
    ...
    public partial interface ID3D11VideoContext1 : ID3D11VideoContext
    {
        ...
        // ID3D11VideoContext1
        [PreserveSig]
        HRESULT SubmitDecoderBuffers1(/* [annotation] _In_ */ ID3D11VideoDecoder pDecoder, /* [annotation] _In_ */ uint NumBuffers, /* [annotation] _In_reads_(NumBuffers) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D11_VIDEO_DECODER_BUFFER_DESC1[] pBufferDesc);
        
        [PreserveSig]
        HRESULT GetDataForNewHardwareKey(/* [annotation] _In_ */ ID3D11CryptoSession pCryptoSession, /* [annotation] _In_ */ uint PrivateInputSize, /* [annotation] _In_reads_(PrivateInputSize) */ out IntPtr pPrivatInputData, /* [annotation] _Out_ */ out ulong pPrivateOutputData);
