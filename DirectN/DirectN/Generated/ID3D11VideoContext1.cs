// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d3d11_1.h(2646,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D11VideoContext1 : ID3D11VideoContext
    {
        ...
        // ID3D11VideoContext1
        [PreserveSig]
        HRESULT SubmitDecoderBuffers1(/* [annotation] _In_ */ ID3D11VideoDecoder pDecoder, /* [annotation] _In_ */ int NumBuffers, /* [annotation] _In_reads_(NumBuffers) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D11_VIDEO_DECODER_BUFFER_DESC1[] pBufferDesc);
