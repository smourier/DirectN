...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext1 : ID2D1DeviceContext
    {
        ...
        // ID2D1DeviceContext1
        [PreserveSig]
        HRESULT CreateFilledGeometryRealization(/* _In_ */ ID2D1Geometry geometry, float flatteningTolerance, /* _COM_Outptr_ */ out ID2D1GeometryRealization geometryRealization);
        
        [PreserveSig]
        HRESULT CreateStrokedGeometryRealization(/* _In_ */ ID2D1Geometry geometry, float flatteningTolerance, float strokeWidth, /* _In_opt_ */ ID2D1StrokeStyle strokeStyle, /* _COM_Outptr_ */ out ID2D1GeometryRealization geometryRealization);
        
        [PreserveSig]
        void DrawGeometryRealization(/* _In_ */ ID2D1GeometryRealization geometryRealization, /* _In_ */ ID2D1Brush brush);
    }
}
