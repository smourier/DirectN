...
namespace DirectN
{
    [Guid("507393f4-2a3d-4a60-b59e-d9c75716c2dd"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IPropertyDescriptionRelatedPropertyInfo : IPropertyDescription
    {
        ...
        [PreserveSig]
        HRESULT GetRelatedProperty(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPWStr)] string pszRelationshipName, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [iid_is][out] __RPC__deref_out_opt */ [MarshalAs(UnmanagedType.IUnknown)] out object ppv);
    }
}
