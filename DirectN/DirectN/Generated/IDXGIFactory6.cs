...
namespace DirectN
{
    ...
    public partial interface IDXGIFactory6 : IDXGIFactory5
    {
        ...
        [PreserveSig]
        new HRESULT GetSharedResourceAdapterLuid(/* [annotation] _In_ */ IntPtr hResource, /* [annotation] _Out_ */ out _LUID pLuid);
        ...
        // IDXGIFactory4
        [PreserveSig]
        new HRESULT EnumAdapterByLuid(/* [annotation] _In_ */ _LUID AdapterLuid, /* [annotation] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [annotation] _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvAdapter);
        ...
        // IDXGIFactory5
        [PreserveSig]
        new HRESULT CheckFeatureSupport(DXGI_FEATURE Feature, /* [annotation] _Inout_updates_bytes_(FeatureSupportDataSize) */ out IntPtr pFeatureSupportData, uint FeatureSupportDataSize);
