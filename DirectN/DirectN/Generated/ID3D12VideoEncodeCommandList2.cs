// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12video.h(7116,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12VideoEncodeCommandList2 : ID3D12VideoEncodeCommandList1
    {
        ...
        [PreserveSig]
        void EncodeFrame(/* _In_ */ ID3D12VideoEncoder pEncoder, /* _In_ */ ID3D12VideoEncoderHeap pHeap, /* _In_ */ ref D3D12_VIDEO_ENCODER_ENCODEFRAME_INPUT_ARGUMENTS pInputArguments, /* _In_ */ ref D3D12_VIDEO_ENCODER_ENCODEFRAME_OUTPUT_ARGUMENTS pOutputArguments);
        
        [PreserveSig]
        void ResolveEncoderOutputMetadata(/* _In_ */ ref D3D12_VIDEO_ENCODER_RESOLVE_METADATA_INPUT_ARGUMENTS pInputArguments, /* _In_ */ ref D3D12_VIDEO_ENCODER_RESOLVE_METADATA_OUTPUT_ARGUMENTS pOutputArguments);
    }
}
