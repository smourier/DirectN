...
namespace DirectN
{
    ...
    public partial interface IDWriteFactory2
    {
        ...
        [PreserveSig]
        HRESULT TranslateColorGlyphRun(float baselineOriginX, float baselineOriginY, /* _In_ */ ref DWRITE_GLYPH_RUN glyphRun, /* _In_opt_ */ ref DWRITE_GLYPH_RUN_DESCRIPTION glyphRunDescription, DWRITE_MEASURING_MODE measuringMode, /* _In_opt_ */ ref DWRITE_MATRIX worldToDeviceTransform, uint colorPaletteIndex, /* _COM_Outptr_ */ out IDWriteColorGlyphRunEnumerator colorLayers);
        ...
        [PreserveSig]
        HRESULT CreateGlyphRunAnalysis(/* _In_ */ ref DWRITE_GLYPH_RUN glyphRun, /* _In_opt_ */ ref DWRITE_MATRIX transform, DWRITE_RENDERING_MODE renderingMode, DWRITE_MEASURING_MODE measuringMode, DWRITE_GRID_FIT_MODE gridFitMode, DWRITE_TEXT_ANTIALIAS_MODE antialiasMode, float baselineOriginX, float baselineOriginY, /* _COM_Outptr_ */ out IDWriteGlyphRunAnalysis glyphRunAnalysis);
    }
}
