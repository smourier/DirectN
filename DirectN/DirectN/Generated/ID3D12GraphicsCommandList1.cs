...
namespace DirectN
{
    ...
    public partial interface ID3D12GraphicsCommandList1 : ID3D12GraphicsCommandList
    {
        ...
        [PreserveSig]
        void SetSamplePositions(/* _In_ */ uint NumSamplesPerPixel, /* _In_ */ uint NumPixels, /* _In_reads_(NumSamplesPerPixel*NumPixels) */ [In, Out, MarshalAs(UnmanagedType.LPArray)] D3D12_SAMPLE_POSITION[] pSamplePositions);
        
        [PreserveSig]
        void ResolveSubresourceRegion(/* _In_ */ ID3D12Resource pDstResource, /* _In_ */ uint DstSubresource, /* _In_ */ uint DstX, /* _In_ */ uint DstY, /* _In_ */ ID3D12Resource pSrcResource, /* _In_ */ uint SrcSubresource, /* _In_opt_ */ ref tagRECT pSrcRect, /* _In_ */ DXGI_FORMAT Format, /* _In_ */ D3D12_RESOLVE_MODE ResolveMode);
