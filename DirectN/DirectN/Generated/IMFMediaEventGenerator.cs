// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfobjects.h(4131,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFMediaEventGenerator
    {
        ...
        [PreserveSig]
        HRESULT QueueEvent(/* [in] */ uint met, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidExtendedType, /* [in] */ HRESULT hrStatus, /* [unique][in] __RPC__in_opt */ PropVariant pvValue);
    }
}
