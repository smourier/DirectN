...
namespace DirectN
{
    ...
    public partial interface IMFHttpDownloadRequest
    {
        ...
        [PreserveSig]
        HRESULT BeginSendRequest(/* [annotation][size_is][in] _In_reads_opt_(cbPayload) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pbPayload, /* [annotation][in] _In_ */ uint cbPayload, /* [annotation][in] _In_ */ IMFAsyncCallback pCallback, /* [annotation][in] _In_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] object punkState);
        ...
        [PreserveSig]
        HRESULT BeginReadPayload(/* [annotation][size_is][out] _Out_writes_(cb) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pb, /* [annotation][in] _In_ */ uint cb, /* [annotation][in] _In_ */ IMFAsyncCallback pCallback, /* [annotation][in] _In_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] object punkState);
