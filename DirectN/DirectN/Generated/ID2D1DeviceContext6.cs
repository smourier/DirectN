// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d2d1_3.h(1717,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext6 : ID2D1DeviceContext5
    {
        ...
        // ID2D1DeviceContext5
        [PreserveSig]
        new HRESULT CreateSvgDocument(/* _In_opt_ */ IStream inputXmlStream, D2D_SIZE_F viewportSize, /* _COM_Outptr_ */ out ID2D1SvgDocument svgDocument);
        
        [PreserveSig]
        new void DrawSvgDocument(/* _In_ */ ID2D1SvgDocument svgDocument);
        ...
        // ID2D1DeviceContext6
        [PreserveSig]
        void BlendImage(/* _In_ */ ID2D1Image image, D2D1_BLEND_MODE blendMode, /* optional(D2D_POINT_2F) */ IntPtr targetOffset, /* optional(D2D_RECT_F) */ IntPtr imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
    }
}
