...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext6 : ID2D1DeviceContext5
    {
        ...
        // ID2D1DeviceContext5
        [PreserveSig]
        new HRESULT CreateSvgDocument(/* _In_opt_ */ IStream inputXmlStream, D2D1_SIZE_F viewportSize, /* _COM_Outptr_ */ out ID2D1SvgDocument svgDocument);
        ...
        // ID2D1DeviceContext6
        [PreserveSig]
        void BlendImage(/* _In_ */ ref ID2D1Image image, D2D1_BLEND_MODE blendMode, /* optional(D2D1_POINT_2F) */ IntPtr targetOffset, /* optional(D2D1_RECT_F) */ IntPtr imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
    }
}
