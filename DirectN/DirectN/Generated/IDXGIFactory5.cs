...
namespace DirectN
{
    ...
    public partial interface IDXGIFactory5 : IDXGIFactory4
    {
        ...
        // IDXGIFactory5
        [PreserveSig]
        HRESULT CheckFeatureSupport(DXGI_FEATURE Feature, /* [annotation] _Inout_updates_bytes_(FeatureSupportDataSize) */ out IntPtr pFeatureSupportData, uint FeatureSupportDataSize);
    }
}
