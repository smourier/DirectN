...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT UpdateNodeAttributes(/* [in] */ ulong TopoId, /* [in] */ uint cUpdates, /* [size_is][in] __RPC__in_ecount_full(cUpdates) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] _MFTOPONODE_ATTRIBUTE_UPDATE[] pUpdates);
    }
}
