// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\dwrite_3.h(1357,1)
using System;
...
namespace DirectN
{
    ...
    /// </summary>
    [Guid("cfee3140-1157-47ca-8b85-31bfcf3f2d0e"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IDWriteStringList
    {
        ...
        [PreserveSig]
        HRESULT GetLocaleName(uint listIndex, /* _Out_writes_z_(size) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] char[] localeName, uint size);
        
        [PreserveSig]
        HRESULT GetStringLength(uint listIndex, /* _Out_ */ out uint length);
        
        [PreserveSig]
        HRESULT GetString(uint listIndex, /* _Out_writes_z_(stringBufferSize) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] char[] stringBuffer, uint stringBufferSize);
    }
}
