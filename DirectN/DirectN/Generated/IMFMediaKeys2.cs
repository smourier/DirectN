...
namespace DirectN
{
    ...
    public partial interface IMFMediaKeys2 : IMFMediaKeys
    {
        ...
        [PreserveSig]
        HRESULT SetServerCertificate(/* [annotation] _In_reads_bytes_opt_(cb) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] pbServerCertificate, /* [annotation] _In_ */ uint cb);
