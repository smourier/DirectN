...
namespace DirectN
{
    ...
    public partial interface IDWriteTextAnalyzer1 : IDWriteTextAnalyzer
    {
        ...
        [PreserveSig]
        HRESULT GetBaseline(/* _In_ */ IDWriteFontFace fontFace, DWRITE_BASELINE baseline, bool isVertical, bool isSimulationAllowed, DWRITE_SCRIPT_ANALYSIS scriptAnalysis, /* optional(WCHAR) */ IntPtr localeName, /* _Out_ */ out int baselineCoordinate, /* _Out_ */ out bool exists);
