// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d3d12.h(16450,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12GraphicsCommandList5 : ID3D12GraphicsCommandList4
    {
        ...
        [PreserveSig]
        new void RSSetScissorRects(/* _In_range_(0, D3D12_VIEWPORT_AND_SCISSORRECT_OBJECT_COUNT_PER_PIPELINE) */ uint NumRects, /* _In_reads_( NumRects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] tagRECT[] pRects);
        ...
        [PreserveSig]
        new void ClearDepthStencilView(/* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DepthStencilView, /* _In_ */ D3D12_CLEAR_FLAGS ClearFlags, /* _In_ */ float Depth, /* _In_ */ byte Stencil, /* _In_ */ uint NumRects, /* _In_reads_(NumRects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] tagRECT[] pRects);
        
        [PreserveSig]
        new void ClearRenderTargetView(/* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE RenderTargetView, /* _In_ */ [In, Out, MarshalAs(UnmanagedType.LPArray)] float[] ColorRGBA, /* _In_ */ uint NumRects, /* _In_reads_(NumRects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] tagRECT[] pRects);
        ...
        [PreserveSig]
        new void BeginRenderPass(/* _In_ */ uint NumRenderTargets, /* _In_reads_opt_(NumRenderTargets) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_RENDER_PASS_RENDER_TARGET_DESC[] pRenderTargets, /* optional(D3D12_RENDER_PASS_DEPTH_STENCIL_DESC) */ IntPtr pDepthStencil, D3D12_RENDER_PASS_FLAGS Flags);
        ...
        [PreserveSig]
        void RSSetShadingRate(/* _In_ */ D3D12_SHADING_RATE baseShadingRate, /* _In_reads_opt_(D3D12_RS_SET_SHADING_RATE_COMBINER_COUNT) */ [MarshalAs(UnmanagedType.LPArray)] D3D12_SHADING_RATE_COMBINER[] combiners);
        
        [PreserveSig]
        void RSSetShadingRateImage(/* _In_opt_ */ ID3D12Resource shadingRateImage);
    }
}
