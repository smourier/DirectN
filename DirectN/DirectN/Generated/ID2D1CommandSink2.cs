// c:\program files (x86)\windows kits\10\include\10.0.19041.0\um\d2d1_3.h(1018,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID2D1CommandSink2 : ID2D1CommandSink1
    {
        ...
        // ID2D1CommandSink2
        [PreserveSig]
        HRESULT DrawInk(/* _In_ */ ID2D1Ink ink, /* _In_ */ ID2D1Brush brush, /* _In_opt_ */ ID2D1InkStyle inkStyle);
        
        [PreserveSig]
        HRESULT DrawGradientMesh(/* _In_ */ ID2D1GradientMesh gradientMesh);
        
        [PreserveSig]
        HRESULT DrawGdiMetafile(/* _In_ */ ID2D1GdiMetafile gdiMetafile, /* optional(D2D_RECT_F) */ IntPtr destinationRectangle, /* optional(D2D_RECT_F) */ IntPtr sourceRectangle);
    }
}
