...
namespace DirectN
{
    ...
    public partial interface ID2D1Transform : ID2D1TransformNode
    {
        ...
        // ID2D1Transform
        [PreserveSig]
        HRESULT MapOutputRectToInputRects(/* _In_ */ ref tagRECT outputRect, /* _Out_writes_(inputRectsCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] tagRECT[] inputRects, uint inputRectsCount);
