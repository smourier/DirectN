// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfobjects.h(5623,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFPluginControl
    {
        ...
        [PreserveSig]
        HRESULT SetPreferredClsid(uint pluginType, /* [annotation] _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string selector, /* [annotation] _In_opt_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid clsid);
