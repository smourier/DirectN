...
namespace DirectN
{
    ...
    public partial interface IDirect3DCryptoSession9
    {
        ...
        [PreserveSig]
        HRESULT EncryptionBlt(ref IDirect3DSurface9 pSrcSurface, ref IDirect3DSurface9 pDstSurface, uint DstSurfaceSize, [MarshalAs(UnmanagedType.IUnknown)] object pIV);
        
        [PreserveSig]
        HRESULT DecryptionBlt(ref IDirect3DSurface9 pSrcSurface, ref IDirect3DSurface9 pDstSurface, uint SrcSurfaceSize, ref _D3DENCRYPTED_BLOCK_INFO pEncryptedBlockInfo, [MarshalAs(UnmanagedType.IUnknown)] object pContentKey, [MarshalAs(UnmanagedType.IUnknown)] object pIV);
        
        [PreserveSig]
        HRESULT GetSurfacePitch(ref IDirect3DSurface9 pSrcSurface, ref uint pSurfacePitch);
