...
namespace DirectN
{
    ...
    public partial interface ID3D11DeviceContext4 : ID3D11DeviceContext3
    {
        ...
        [PreserveSig]
        new void UpdateSubresource1(/* [annotation] _In_ */ ID3D11Resource pDstResource, /* [annotation] _In_ */ uint DstSubresource, /* [annotation] _In_opt_ */ ref D3D11_BOX pDstBox, /* [annotation] _In_ */ IntPtr pSrcData, /* [annotation] _In_ */ uint SrcRowPitch, /* [annotation] _In_ */ uint SrcDepthPitch, /* [annotation] _In_ */ uint CopyFlags);
        ...
        [PreserveSig]
        new void ClearView(/* [annotation] _In_ */ ID3D11View pView, /* [annotation] _In_ */ [In, Out, MarshalAs(UnmanagedType.LPArray)] float[] Color, /* [annotation] _In_reads_opt_(NumRects) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] tagRECT[] pRect, uint NumRects);
        
        [PreserveSig]
        new void DiscardView1(/* [annotation] _In_ */ ID3D11View pResourceView, /* [annotation] _In_reads_opt_(NumRects) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] tagRECT[] pRects, uint NumRects);
        
        // ID3D11DeviceContext2
        [PreserveSig]
        new HRESULT UpdateTileMappings(/* [annotation] _In_ */ ID3D11Resource pTiledResource, /* [annotation] _In_ */ uint NumTiledResourceRegions, /* [annotation] _In_reads_opt_(NumTiledResourceRegions) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D11_TILED_RESOURCE_COORDINATE[] pTiledResourceRegionStartCoordinates, /* [annotation] _In_reads_opt_(NumTiledResourceRegions) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D11_TILE_REGION_SIZE[] pTiledResourceRegionSizes, /* [annotation] _In_opt_ */ ID3D11Buffer pTilePool, /* [annotation] _In_ */ uint NumRanges, /* [annotation] _In_reads_opt_(NumRanges) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] uint[] pRangeFlags, /* [annotation] _In_reads_opt_(NumRanges) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] uint[] pTilePoolStartOffsets, /* [annotation] _In_reads_opt_(NumRanges) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 5)] uint[] pRangeTileCounts, /* [annotation] _In_ */ uint Flags);
        ...
        [PreserveSig]
        new void Flush1(D3D11_CONTEXT_TYPE ContextType, /* [annotation] _In_opt_ */ IntPtr hEvent);
