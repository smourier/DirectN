// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12.h(19103,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12GraphicsCommandList4 : ID3D12GraphicsCommandList3
    {
        ...
        [PreserveSig]
        void BeginRenderPass(/* _In_ */ int NumRenderTargets, /* _In_reads_opt_(NumRenderTargets) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] D3D12_RENDER_PASS_RENDER_TARGET_DESC[] pRenderTargets, /* optional(D3D12_RENDER_PASS_DEPTH_STENCIL_DESC) */ IntPtr pDepthStencil, D3D12_RENDER_PASS_FLAGS Flags);
