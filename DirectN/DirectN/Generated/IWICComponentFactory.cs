// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\wincodecsdk.h(1848,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IWICComponentFactory : IWICImagingFactory
    {
        ...
        [PreserveSig]
        new HRESULT CreateDecoderFromStream(/* [in] __RPC__in_opt */ ref IStream pIStream, /* [unique][in] __RPC__in_opt */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [in] */ WICDecodeOptions metadataOptions, /* [retval][out] __RPC__deref_out_opt */ out IWICBitmapDecoder ppIDecoder);
        
        [PreserveSig]
        new HRESULT CreateDecoderFromFileHandle(/* [in] */ ulong hFile, /* [unique][in] __RPC__in_opt */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [in] */ WICDecodeOptions metadataOptions, /* [retval][out] __RPC__deref_out_opt */ out IWICBitmapDecoder ppIDecoder);
        ...
        [PreserveSig]
        new HRESULT CreateBitmap(/* [in] */ uint uiWidth, /* [in] */ uint uiHeight, /* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid pixelFormat, /* [in] */ WICBitmapCreateCacheOption option, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        ...
        [PreserveSig]
        new HRESULT CreateBitmapFromHBITMAP(/* [in] __RPC__in */ IntPtr hBitmap, /* [unique][in] __RPC__in_opt */ IntPtr hPalette, /* [in] */ WICBitmapAlphaChannelOption options, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        
        [PreserveSig]
        new HRESULT CreateBitmapFromHICON(/* [in] __RPC__in */ IntPtr hIcon, /* [out] __RPC__deref_out_opt */ out IWICBitmap ppIBitmap);
        
        [PreserveSig]
        new HRESULT CreateComponentEnumerator(/* [in] */ uint componentTypes, /* [in] */ uint options, /* [out] __RPC__deref_out_opt */ out IEnumUnknown ppIEnumUnknown);
        ...
        [PreserveSig]
        HRESULT CreateMetadataReader(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidMetadataFormat, /* [size_is][unique][in] __RPC__in_ecount_full_opt(1) */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [in] */ uint dwOptions, /* [in] __RPC__in_opt */ ref IStream pIStream, /* [out] __RPC__deref_out_opt */ out IWICMetadataReader ppIReader);
        
        [PreserveSig]
        HRESULT CreateMetadataReaderFromContainer(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidContainerFormat, /* [size_is][unique][in] __RPC__in_ecount_full_opt(1) */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [in] */ uint dwOptions, /* [in] __RPC__in_opt */ ref IStream pIStream, /* [out] __RPC__deref_out_opt */ out IWICMetadataReader ppIReader);
        
        [PreserveSig]
        HRESULT CreateMetadataWriter(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidMetadataFormat, /* [size_is][unique][in] __RPC__in_ecount_full_opt(1) */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [in] */ uint dwMetadataOptions, /* [out] __RPC__deref_out_opt */ out IWICMetadataWriter ppIWriter);
        
        [PreserveSig]
        HRESULT CreateMetadataWriterFromReader(/* [in] __RPC__in_opt */ IWICMetadataReader pIReader, /* [unique][in] __RPC__in_opt */ [MarshalAs(UnmanagedType.LPStruct)] Guid pguidVendor, /* [out] __RPC__deref_out_opt */ out IWICMetadataWriter ppIWriter);
        ...
        [PreserveSig]
        HRESULT CreateEncoderPropertyBag(/* [size_is][unique][in] __RPC__in_ecount_full_opt(cCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] tagPROPBAG2[] ppropOptions, /* [in] */ uint cCount, /* [out] __RPC__deref_out_opt */ out IPropertyBag2 ppIPropertyBag);
    }
}
