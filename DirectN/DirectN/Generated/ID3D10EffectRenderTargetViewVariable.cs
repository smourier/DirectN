// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d3d10effect.h(723,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D10EffectRenderTargetViewVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT SetRenderTargetArray(/* THIS_ _In_reads_(Count) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] ID3D10RenderTargetView[] ppResources, uint Offset, uint Count);
