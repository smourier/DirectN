// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d10effect.h(723,1)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("28ca0cc3-c2c9-40bb-b57f-67b737122b17"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D10EffectRenderTargetViewVariable : ID3D10EffectVariable
    {
        ...
        [PreserveSig]
        HRESULT SetRenderTargetArray(/* THIS_ _In_reads_(Count) */ out ID3D10RenderTargetView[] ppResources, uint Offset, uint Count);
        
        [PreserveSig]
        HRESULT GetRenderTargetArray(/* THIS_ _Out_writes_(Count) */ out ID3D10RenderTargetView[] ppResources, uint Offset, uint Count);
    }
}
