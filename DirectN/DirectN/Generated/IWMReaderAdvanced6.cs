// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\wmsdkidl.h(12562,5)
using System;
...
namespace DirectN
{
    [Guid("18a2e7f8-428f-4acd-8a00-e64639bc93de"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IWMReaderAdvanced6 : IWMReaderAdvanced5
    {
        ...
        [PreserveSig]
        new HRESULT StartAtMarker(/* [in] */ ushort wMarkerIndex, /* [in] */ ulong cnsDuration, /* [in] */ float fRate, /* [in] */ [MarshalAs(UnmanagedType.IUnknown)] object pvContext);
        ...
        [PreserveSig]
        new HRESULT OpenStream(/* [in] */ IStream pStream, /* [in] */ IWMReaderCallback pCallback, /* [in] */ [MarshalAs(UnmanagedType.IUnknown)] object pvContext);
        ...
        [PreserveSig]
        new HRESULT StartAtPosition(/* [in] */ ushort wStreamNum, /* [in] */ [MarshalAs(UnmanagedType.IUnknown)] object pvOffsetStart, /* [in] */ [MarshalAs(UnmanagedType.IUnknown)] object pvDuration, /* [in] */ tagWMT_OFFSET_FORMAT dwOffsetFormat, /* [in] */ float fRate, /* [in] */ [MarshalAs(UnmanagedType.IUnknown)] object pvContext);
        ...
        // IWMReaderAdvanced5
        [PreserveSig]
        new HRESULT SetPlayerHook(/* [in] */ uint dwOutputNum, /* [in] */ IWMPlayerHook pHook);
        
        // IWMReaderAdvanced6
        [PreserveSig]
        HRESULT SetProtectStreamSamples(/* [size_is][in] */ [MarshalAs(UnmanagedType.LPArray)] byte[] pbCertificate, /* [in] */ uint cbCertificate, /* [in] */ uint dwCertificateType, /* [in] */ uint dwFlags, /* [size_is][out] */ [Out, MarshalAs(UnmanagedType.LPArray)] byte[] pbInitializationVector, /* [out][in] */ ref uint pcbInitializationVector);
    }
}
