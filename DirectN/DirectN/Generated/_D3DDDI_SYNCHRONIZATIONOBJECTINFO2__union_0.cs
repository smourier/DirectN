...
namespace DirectN
{
    ...
    public partial struct _D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0
    {
        ...
        public _D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_4 MonitoredFence { get => InteropRuntime.Get<_D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_4>(__bits, 0, 224); set { if (__bits == null) __bits = new byte[64]; InteropRuntime.Set<_D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_4>(value, __bits, 0, 224); } }
        public _D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_5 PeriodicMonitoredFence { get => InteropRuntime.Get<_D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_5>(__bits, 0, 288); set { if (__bits == null) __bits = new byte[64]; InteropRuntime.Set<_D3DDDI_SYNCHRONIZATIONOBJECTINFO2__union_0__struct_5>(value, __bits, 0, 288); } }
