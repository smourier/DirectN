...
namespace DirectN
{
    ...
    public partial interface ID3D12Resource : ID3D12Pageable
    {
        ...
        [PreserveSig]
        HRESULT WriteToSubresource(uint DstSubresource, /* optional(D3D12_BOX) */ IntPtr pDstBox, /* _In_ */ [MarshalAs(UnmanagedType.IUnknown)] object pSrcData, uint SrcRowPitch, uint SrcDepthPitch);
