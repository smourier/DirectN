// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\wincodec.h(1300,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IWICBitmapSource
    {
        ...
        [PreserveSig]
        HRESULT CopyPixels(/* optional(WICRect) */ IntPtr prc, /* [in] */ uint cbStride, /* [in] */ uint cbBufferSize, /* [size_is][out] __RPC__out_ecount_full(cbBufferSize) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] byte[] pbBuffer);
    }
}
