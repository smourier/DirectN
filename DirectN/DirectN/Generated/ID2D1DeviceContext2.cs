...
namespace DirectN
{
    ...
    public partial interface ID2D1DeviceContext2
    {
        ...
        [PreserveSig]
        HRESULT GetGradientMeshWorldBounds(/* _In_ */ ID2D1GradientMesh gradientMesh, /* _Out_ */ out D2D1_RECT_F pBounds);
        ...
        [PreserveSig]
        void DrawGdiMetafile(/* _In_ */ ref ID2D1GdiMetafile gdiMetafile, /* optional(D2D1_RECT_F) */ IntPtr destinationRectangle, /* optional(D2D1_RECT_F) */ IntPtr sourceRectangle);
