// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d11_2.h(169,5)
using System;
...
namespace DirectN
{
    [Guid("420d5b32-b90c-4da4-bef0-359f6a24a83a"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D11DeviceContext2 : ID3D11DeviceContext1
    {
        ...
        [PreserveSig]
        void TiledResourceBarrier(/* [annotation] _In_opt_ */ ID3D11DeviceChild pTiledResourceOrViewAccessBeforeBarrier, /* [annotation] _In_opt_ */ ID3D11DeviceChild pTiledResourceOrViewAccessAfterBarrier);
        
        [PreserveSig]
        bool IsAnnotationEnabled();
        
        [PreserveSig]
        void SetMarkerInt(/* [annotation] _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string pLabel, int Data);
        
        [PreserveSig]
        void BeginEventInt(/* [annotation] _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string pLabel, int Data);
