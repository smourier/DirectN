...
namespace DirectN
{
    ...
    public partial interface ID3D11DeviceContext2 : ID3D11DeviceContext1
    {
        ...
        [PreserveSig]
        HRESULT ResizeTilePool(/* [annotation] _In_ */ ref ID3D11Buffer pTilePool, /* [annotation] _In_ */ ulong NewSizeInBytes);
        
        [PreserveSig]
        void TiledResourceBarrier(/* optional(ID3D11DeviceChild) */ IntPtr pTiledResourceOrViewAccessBeforeBarrier, /* optional(ID3D11DeviceChild) */ IntPtr pTiledResourceOrViewAccessAfterBarrier);
