// c:\program files (x86)\windows kits\10\include\10.0.22000.0\shared\d3dkmthk.h(3727,9)
...
namespace DirectN
{
    ...
    public partial struct _D3DKMT_QUERYSTATISTICS_RESULT
    {
        ...
        public _D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION ProcessSegmentInformation { get => InteropRuntime.Get<_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION>(__bits, 0, 1664); set { if (__bits == null) __bits = new byte[904]; InteropRuntime.Set<_D3DKMT_QUERYSTATISTICS_PROCESS_SEGMENT_INFORMATION>(value, __bits, 0, 1664); } }
