// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\dwrite_3.h(3340,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDWriteTextLayout4 : IDWriteTextLayout3
    {
        ...
        [PreserveSig]
        HRESULT GetFontAxisValues(uint currentPosition, /* _Out_writes_(fontAxisValueCount) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, int fontAxisValueCount, /* optional(DWRITE_TEXT_RANGE) */ IntPtr textRange);
