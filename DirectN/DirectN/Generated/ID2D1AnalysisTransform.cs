...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT ProcessAnalysisResults(/* _In_reads_(analysisDataCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] byte[] analysisData, uint analysisDataCount);
    }
}
