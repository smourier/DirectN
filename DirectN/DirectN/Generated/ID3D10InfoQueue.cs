// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d10sdklayers.h(949,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [ComImport, Guid("1b940b17-2642-4d1f-ab1f-b99bad0c395f"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D10InfoQueue
    {
        ...
        [PreserveSig]
        HRESULT GetMessageW(/* [annotation] _In_ */ ulong MessageIndex, /* optional(D3D10_MESSAGE) */ IntPtr pMessage, /* [annotation] _Inout_ */ IntPtr pMessageByteLength);
        ...
        [PreserveSig]
        HRESULT GetStorageFilter(/* optional(D3D10_INFO_QUEUE_FILTER) */ IntPtr pFilter, /* [annotation] _Inout_ */ IntPtr pFilterByteLength);
        ...
        [PreserveSig]
        HRESULT GetRetrievalFilter(/* optional(D3D10_INFO_QUEUE_FILTER) */ IntPtr pFilter, /* [annotation] _Inout_ */ IntPtr pFilterByteLength);
