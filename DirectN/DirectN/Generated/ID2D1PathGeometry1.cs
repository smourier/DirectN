...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT ComputePointAndSegmentAtLength(float length, uint startSegment, /* optional(D2D1_MATRIX_3X2_F) */ IntPtr worldTransform, float flatteningTolerance, /* _Out_ */ out D2D1_POINT_DESCRIPTION pointDescription);
    }
}
