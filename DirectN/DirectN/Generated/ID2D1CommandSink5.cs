// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d2d1_3.h(1704,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID2D1CommandSink5 : ID2D1CommandSink4
    {
        ...
        // ID2D1CommandSink5
        [PreserveSig]
        HRESULT BlendImage(/* _In_ */ ID2D1Image image, D2D1_BLEND_MODE blendMode, /* optional(D2D_POINT_2F) */ IntPtr targetOffset, /* optional(D2D_RECT_F) */ IntPtr imageRectangle, D2D1_INTERPOLATION_MODE interpolationMode);
    }
}
