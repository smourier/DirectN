...
namespace DirectN
{
    ...
    public partial interface ID3D12InfoQueue1 : ID3D12InfoQueue
    {
        ...
        // ID3D12InfoQueue1
        [PreserveSig]
        HRESULT RegisterMessageCallback(/* _In_ */ D3D12MessageFunc CallbackFunc, /* _In_ */ D3D12_MESSAGE_CALLBACK_FLAGS CallbackFilterFlags, /* _In_ */ IntPtr pContext, /* _Inout_ */ ref uint pCallbackCookie);
