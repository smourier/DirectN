// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12sdklayers.h(3258,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12InfoQueue1 : ID3D12InfoQueue
    {
        ...
        // ID3D12InfoQueue1
        [PreserveSig]
        HRESULT RegisterMessageCallback(/* _In_ */ ref D3D12MessageFunc CallbackFunc, /* _In_ */ D3D12_MESSAGE_CALLBACK_FLAGS CallbackFilterFlags, /* _In_ */ IntPtr pContext, /* _Inout_ */ ref uint pCallbackCookie);
