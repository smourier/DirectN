...
namespace DirectN
{
    ...
    public partial interface IDxcOptimizer
    {
        ...
        [PreserveSig]
        HRESULT RunOptimizer(IDxcBlob pBlob, /* _In_count_(optionCount) */ out IntPtr ppOptions, uint optionCount, /* _COM_Outptr_ */ out IDxcBlob pOutputModule, /* _COM_Outptr_opt_ */ out IDxcBlobEncoding ppOutputText);
    }
}
