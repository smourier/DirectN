...
namespace DirectN
{
    ...
    public partial struct _D3DKMT_PRESENTHISTORYTOKEN__union_0
    {
        ...
        public byte[] __bits;
        public byte[] MaxSize {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.GetArray<byte>(__bits, 0, 8512);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[1064]; InteropRuntime.SetArray<byte>(value, __bits, 0, 8512); } }
        public _D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN Flip {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN>(__bits, 0, 8448);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[1064]; InteropRuntime.Set<_D3DKMT_FLIPMODEL_PRESENTHISTORYTOKEN>(value, __bits, 0, 8448); } }
