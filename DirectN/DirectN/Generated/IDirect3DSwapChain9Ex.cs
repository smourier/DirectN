// c:\program files (x86)\windows kits\10\include\10.0.22000.0\shared\d3d9.h(206,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDirect3DSwapChain9Ex : IDirect3DSwapChain9
    {
        ...
        [PreserveSig]
        new HRESULT GetPresentParameters(/*ref _D3DPRESENT_PARAMETERS_*/ IntPtr pPresentationParameters);
        ...
        [PreserveSig]
        HRESULT GetPresentStats(/*ref _D3DPRESENTSTATS*/ IntPtr pPresentationStatistics);
