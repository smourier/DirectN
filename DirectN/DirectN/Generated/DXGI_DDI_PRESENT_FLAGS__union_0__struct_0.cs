...
namespace DirectN
{
    ...
    public partial struct DXGI_DDI_PRESENT_FLAGS__union_0__struct_0
    {
        ...
        public uint Flip { get => InteropRuntime.GetUInt32(__bits, 1, 1); set => InteropRuntime.SetUInt32(value, __bits, 1, 1); }
        public uint PreferRight { get => InteropRuntime.GetUInt32(__bits, 2, 1); set => InteropRuntime.SetUInt32(value, __bits, 2, 1); }
