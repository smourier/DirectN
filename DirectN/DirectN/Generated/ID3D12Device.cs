...
namespace DirectN
{
    ...
    public partial interface ID3D12Device : ID3D12Object
    {
        ...
        [PreserveSig]
        HRESULT CheckFeatureSupport(D3D12_FEATURE Feature, /* _Inout_updates_bytes_(FeatureSupportDataSize) */ out IntPtr pFeatureSupportData, uint FeatureSupportDataSize);
        ...
        [PreserveSig]
        HRESULT CreateRootSignature(/* _In_ */ uint nodeMask, /* _In_reads_(blobLengthInBytes) */ out IntPtr pBlobWithRootSignature, /* _In_ */ ulong blobLengthInBytes, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvRootSignature);
        
        [PreserveSig]
        void CreateConstantBufferView(/* _In_opt_ */ ref D3D12_CONSTANT_BUFFER_VIEW_DESC pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        [PreserveSig]
        void CreateShaderResourceView(/* _In_opt_ */ ID3D12Resource pResource, /* _In_opt_ */ ref D3D12_SHADER_RESOURCE_VIEW_DESC pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        [PreserveSig]
        void CreateUnorderedAccessView(/* _In_opt_ */ ID3D12Resource pResource, /* _In_opt_ */ ID3D12Resource pCounterResource, /* _In_opt_ */ ref D3D12_UNORDERED_ACCESS_VIEW_DESC pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        [PreserveSig]
        void CreateRenderTargetView(/* _In_opt_ */ ID3D12Resource pResource, /* _In_opt_ */ ref D3D12_RENDER_TARGET_VIEW_DESC pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        
        [PreserveSig]
        void CreateDepthStencilView(/* _In_opt_ */ ID3D12Resource pResource, /* _In_opt_ */ ref D3D12_DEPTH_STENCIL_VIEW_DESC pDesc, /* _In_ */ D3D12_CPU_DESCRIPTOR_HANDLE DestDescriptor);
        ...
        [PreserveSig]
        D3D12_RESOURCE_ALLOCATION_INFO GetResourceAllocationInfo(/* _In_ */ uint visibleMask, /* _In_ */ uint numResourceDescs, /* _In_reads_(numResourceDescs) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] D3D12_RESOURCE_DESC[] pResourceDescs);
        ...
        [PreserveSig]
        HRESULT CreateReservedResource(/* _In_ */ ref D3D12_RESOURCE_DESC pDesc, D3D12_RESOURCE_STATES InitialState, /* _In_opt_ */ ref D3D12_CLEAR_VALUE pOptimizedClearValue, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvResource);
        
        [PreserveSig]
        HRESULT CreateSharedHandle(/* _In_ */ ID3D12DeviceChild pObject, /* _In_opt_ */ ref _SECURITY_ATTRIBUTES pAttributes, uint Access, /* _In_opt_ */ [MarshalAs(UnmanagedType.LPWStr)] string Name, /* _Out_ */ [MarshalAs(UnmanagedType.IUnknown)] out object pHandle);
        ...
        [PreserveSig]
        HRESULT OpenSharedHandleByName(/* _In_ */ [MarshalAs(UnmanagedType.LPWStr)] string Name, uint Access, /* [annotation][out] _Out_ */ [MarshalAs(UnmanagedType.IUnknown)] out object pNTHandle);
        
        [PreserveSig]
        HRESULT MakeResident(uint NumObjects, /* _In_reads_(NumObjects) */ out ID3D12Pageable[] ppObjects);
        
        [PreserveSig]
        HRESULT Evict(uint NumObjects, /* _In_reads_(NumObjects) */ out ID3D12Pageable[] ppObjects);
