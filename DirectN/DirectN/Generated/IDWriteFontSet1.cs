...
namespace DirectN
{
    ...
    public partial interface IDWriteFontSet1 : IDWriteFontSet
    {
        ...
        // IDWriteFontSet1
        [PreserveSig]
        HRESULT GetMatchingFonts(/* _In_opt_ */ ref DWRITE_FONT_PROPERTY fontProperty, /* _In_reads_(fontAxisValueCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, /* _COM_Outptr_ */ out IDWriteFontSet1 matchingFonts);
        
        [PreserveSig]
        HRESULT GetFirstFontResources(/* _COM_Outptr_ */ out IDWriteFontSet1 filteredFontSet);
        
        [PreserveSig]
        HRESULT GetFilteredFonts(/* _In_reads_opt_(propertyCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_FONT_PROPERTY[] properties, uint propertyCount, bool selectAnyProperty, /* _COM_Outptr_ */ out IDWriteFontSet1 filteredFontSet);
        
        [PreserveSig]
        HRESULT GetFilteredFonts(/* _In_reads_(fontAxisRangeCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_FONT_AXIS_RANGE[] fontAxisRanges, uint fontAxisRangeCount, bool selectAnyRange, /* _COM_Outptr_ */ out IDWriteFontSet1 filteredFontSet);
        
        [PreserveSig]
        HRESULT GetFilteredFonts(/* _In_reads_(indexCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] uint[] indices, uint indexCount, /* _COM_Outptr_ */ out IDWriteFontSet1 filteredFontSet);
        ...
        [PreserveSig]
        HRESULT GetFontAxisRanges(/* _Out_writes_(maxFontAxisRangeCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] DWRITE_FONT_AXIS_RANGE[] fontAxisRanges, uint maxFontAxisRangeCount, /* _Out_ */ out uint actualFontAxisRangeCount);
        
        [PreserveSig]
        HRESULT GetFontAxisRanges(uint listIndex, /* _Out_writes_(maxFontAxisRangeCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] DWRITE_FONT_AXIS_RANGE[] fontAxisRanges, uint maxFontAxisRangeCount, /* _Out_ */ out uint actualFontAxisRangeCount);
