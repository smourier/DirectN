// c:\program files (x86)\windows kits\10\include\10.0.19041.0\um\d2d1_3.h(1229,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID2D1CommandSink3 : ID2D1CommandSink2
    {
        ...
        // ID2D1CommandSink3
        [PreserveSig]
        HRESULT DrawSpriteBatch(/* _In_ */ ID2D1SpriteBatch spriteBatch, uint startIndex, uint spriteCount, /* _In_ */ ID2D1Bitmap bitmap, D2D1_BITMAP_INTERPOLATION_MODE interpolationMode, D2D1_SPRITE_OPTIONS spriteOptions);
    }
}
