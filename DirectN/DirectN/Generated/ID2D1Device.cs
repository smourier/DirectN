...
namespace DirectN
{
    ...
    public partial interface ID2D1Device
    {
        ...
        [PreserveSig]
        HRESULT CreatePrintControl(/* _In_ */ ref IWICImagingFactory wicFactory, /* _In_ */ ref IPrintDocumentPackageTarget documentTarget, /* _In_opt_ */ ref D2D1_PRINT_CONTROL_PROPERTIES printControlProperties, /* _COM_Outptr_ */ out ID2D1PrintControl printControl);
