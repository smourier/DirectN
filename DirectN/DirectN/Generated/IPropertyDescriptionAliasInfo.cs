// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\propsys.h(2436,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("f67104fc-2af9-46fd-b32d-243c1404f3d1"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IPropertyDescriptionAliasInfo : IPropertyDescription
    {
        ...
        [PreserveSig]
        HRESULT GetSortByAlias(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [iid_is][out] __RPC__deref_out_opt */ [MarshalAs(UnmanagedType.IUnknown)] out object ppv);
        
        [PreserveSig]
        HRESULT GetAdditionalSortByAliases(/* [in] __RPC__in */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [iid_is][out] __RPC__deref_out_opt */ [MarshalAs(UnmanagedType.IUnknown)] out object ppv);
    }
}
