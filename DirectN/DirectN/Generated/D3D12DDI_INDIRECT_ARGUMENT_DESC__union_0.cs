...
namespace DirectN
{
    ...
    public partial struct D3D12DDI_INDIRECT_ARGUMENT_DESC__union_0
    {
        ...
        public D3D12DDI_INDIRECT_ARGUMENT_DESC__union_0__struct_5 IncrementingConstant {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<D3D12DDI_INDIRECT_ARGUMENT_DESC__union_0__struct_5>(__bits, 0, 64);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[12]; InteropRuntime.Set<D3D12DDI_INDIRECT_ARGUMENT_DESC__union_0__struct_5>(value, __bits, 0, 64); } }
    }
}
