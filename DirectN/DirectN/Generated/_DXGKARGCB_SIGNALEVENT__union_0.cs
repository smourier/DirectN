...
namespace DirectN
{
    ...
    public partial struct _DXGKARGCB_SIGNALEVENT__union_0
    {
        ...
        public byte[] __bits;
        public _DXGKARGCB_SIGNALEVENT__union_0__struct_0 __field_0 { get => InteropRuntime.Get<_DXGKARGCB_SIGNALEVENT__union_0__struct_0>(__bits, 0, 32); set => InteropRuntime.Set<_DXGKARGCB_SIGNALEVENT__union_0__struct_0>(value, __bits, 0, 32); }
