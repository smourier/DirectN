...
namespace DirectN
{
    ...
    public partial struct DISPLAYCONFIG_SUPPORT_VIRTUAL_RESOLUTION__union_0
    {
        ...
        public byte[] __bits;
        public DISPLAYCONFIG_SUPPORT_VIRTUAL_RESOLUTION__union_0__struct_0 __field_0 {  [MethodImpl(MethodImplOptions.AggressiveInlining)] get => InteropRuntime.Get<DISPLAYCONFIG_SUPPORT_VIRTUAL_RESOLUTION__union_0__struct_0>(__bits, 0, 32);  [MethodImpl(MethodImplOptions.AggressiveInlining)] set { if (__bits == null) __bits = new byte[4]; InteropRuntime.Set<DISPLAYCONFIG_SUPPORT_VIRTUAL_RESOLUTION__union_0__struct_0>(value, __bits, 0, 32); } }
