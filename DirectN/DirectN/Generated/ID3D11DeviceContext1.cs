...
namespace DirectN
{
    ...
    public partial interface ID3D11DeviceContext1 : ID3D11DeviceContext
    {
        ...
        [PreserveSig]
        void ClearView(/* [annotation] _In_ */ ID3D11View pView, /* [annotation] _In_ */ [In, Out, MarshalAs(UnmanagedType.LPArray)] float[] Color, /* [annotation] _In_reads_opt_(NumRects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] D3D11_RECT[] pRect, uint NumRects);
        
        [PreserveSig]
        void DiscardView1(/* [annotation] _In_ */ ID3D11View pResourceView, /* [annotation] _In_reads_opt_(NumRects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] D3D11_RECT[] pRects, uint NumRects);
    }
}
