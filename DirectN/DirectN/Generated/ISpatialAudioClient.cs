...
namespace DirectN
{
    ...
    public partial interface ISpatialAudioClient
    {
        ...
        [PreserveSig]
        HRESULT ActivateSpatialAudioStream(/* [annotation][in] _In_ */ PropVariant activationParams, /* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [annotation][iid_is][out] _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object stream);
    }
}
