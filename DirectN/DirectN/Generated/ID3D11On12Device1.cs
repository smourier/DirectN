// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\d3d11on12.h(280,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("bdb64df4-ea2f-4c70-b861-aaab1258bb5d"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface ID3D11On12Device1 : ID3D11On12Device
    {
        ...
        [PreserveSig]
        new void ReleaseWrappedResources(/* _In_reads_( NumResources ) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ID3D11Resource[] ppResources, uint NumResources);
        
        [PreserveSig]
        new void AcquireWrappedResources(/* _In_reads_( NumResources ) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ID3D11Resource[] ppResources, uint NumResources);
