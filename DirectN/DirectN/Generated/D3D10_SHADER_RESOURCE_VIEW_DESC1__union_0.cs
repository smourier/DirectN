...
namespace DirectN
{
    ...
    public partial struct D3D10_SHADER_RESOURCE_VIEW_DESC1__union_0
    {
        ...
        public D3D10_TEXCUBE_ARRAY_SRV1 TextureCubeArray { get => InteropRuntime.Get<D3D10_TEXCUBE_ARRAY_SRV1>(__bits, 0, 128); set => InteropRuntime.Set<D3D10_TEXCUBE_ARRAY_SRV1>(value, __bits, 0, 128); }
    }
}
