// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfreadwrite.h(617,5)
using System;
using System.Runtime.InteropServices;

namespace DirectN
{
    [Guid("7b981cf0-560e-4116-9875-b099895f23d7"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IMFSourceReaderEx : IMFSourceReader
    {
        ...
        [PreserveSig]
        new HRESULT GetPresentationAttribute(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid guidAttribute, /* [annotation][out] _Out_ */ out PropVariant pvarAttribute);
