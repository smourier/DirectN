// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\mfreadwrite.h(643,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFSourceReaderEx : IMFSourceReader
    {
        ...
        [PreserveSig]
        new HRESULT SetCurrentMediaType(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][out][in] _Reserved_ */ IntPtr pdwReserved, /* [annotation][in] _In_ */ IMFMediaType pMediaType);
