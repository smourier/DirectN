// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\d3d12.h(20197,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D12Device9 : ID3D12Device8
    {
        ...
        // ID3D12Device9
        [PreserveSig]
        HRESULT CreateShaderCacheSession(/* _In_ */ ref D3D12_SHADER_CACHE_SESSION_DESC pDesc, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_opt_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvSession);
        
        [PreserveSig]
        HRESULT ShaderCacheControl(D3D12_SHADER_CACHE_KIND_FLAGS Kinds, D3D12_SHADER_CACHE_CONTROL_FLAGS Control);
        
        [PreserveSig]
        HRESULT CreateCommandQueue1(/* _In_ */ ref D3D12_COMMAND_QUEUE_DESC pDesc, [MarshalAs(UnmanagedType.LPStruct)] Guid CreatorID, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppCommandQueue);
    }
}
