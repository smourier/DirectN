// c:\program files (x86)\windows kits\10\include\10.0.22000.0\um\strmif.h(7905,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IFilterGraph3 : IFilterGraph2
    {
        ...
        [PreserveSig]
        new HRESULT RenderEx(/* [in] */ IPin pPinOut, /* [in] */ uint dwFlags, /* [annotation][out][in] _Reserved_ */ IntPtr pvContext);
