...
namespace DirectN
{
    ...
    {
        [PreserveSig]
        HRESULT CreateModuleInstance(/* THIS_ _COM_Outptr_ */ out ID3D11ModuleInstance ppModuleInstance, /* optional(ID3DBlob) */ out IntPtr ppErrorBuffer);
        ...
        [PreserveSig]
        HRESULT GetLastError(/* optional(ID3DBlob) */ out IntPtr ppErrorBuffer);
        
        [PreserveSig]
        HRESULT GenerateHlsl(/* THIS_ _In_ */ uint uFlags, /* // uFlags is reserved for future use. _COM_Outptr_ */ out ID3DBlob ppBuffer);
    }
}
