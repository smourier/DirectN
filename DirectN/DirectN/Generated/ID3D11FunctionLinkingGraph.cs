// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\d3d11shader.h(539,1)
using System;
...
namespace DirectN
{
    ...
    public partial interface ID3D11FunctionLinkingGraph
    {
        ...
        [PreserveSig]
        HRESULT SetInputSignature(/* THIS_ __in_ecount(cInputParameters) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] _D3D11_PARAMETER_DESC[] pInputParameters, /* _In_ */ uint cInputParameters, /* _COM_Outptr_ */ out ID3D11LinkingNode ppInputNode);
        
        [PreserveSig]
        HRESULT SetOutputSignature(/* THIS_ __in_ecount(cOutputParameters) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] _D3D11_PARAMETER_DESC[] pOutputParameters, /* _In_ */ uint cOutputParameters, /* _COM_Outptr_ */ out ID3D11LinkingNode ppOutputNode);
