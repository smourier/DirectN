// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\mfcaptureengine.h(1849,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IMFCaptureSink2 : IMFCaptureSink
    {
        ...
        // IMFCaptureSink2
        [PreserveSig]
        HRESULT SetOutputMediaType(/* [annotation][in] _In_ */ uint dwStreamIndex, /* [annotation][in] _In_ */ ref IMFMediaType pMediaType, /* optional(IMFAttributes) */ IntPtr pEncodingAttributes);
    }
}
