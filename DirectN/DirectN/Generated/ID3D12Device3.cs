...
namespace DirectN
{
    ...
    public partial interface ID3D12Device3 : ID3D12Device2
    {
        ...
        // ID3D12Device3
        [PreserveSig]
        HRESULT OpenExistingHeapFromAddress(/* _In_ */ IntPtr pAddress, [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppvHeap);
