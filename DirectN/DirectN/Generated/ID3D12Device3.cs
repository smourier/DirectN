...
namespace DirectN
{
    ...
    public partial interface ID3D12Device3 : ID3D12Device2
    {
        ...
        [PreserveSig]
        HRESULT EnqueueMakeResident(D3D12_RESIDENCY_FLAGS Flags, uint NumObjects, /* _In_reads_(NumObjects) */ out ID3D12Pageable[] ppObjects, /* _In_ */ ID3D12Fence pFenceToSignal, ulong FenceValueToSignal);
    }
}
