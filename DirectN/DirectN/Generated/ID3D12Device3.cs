...
namespace DirectN
{
    ...
    public partial interface ID3D12Device3 : ID3D12Device2
    {
        ...
        [PreserveSig]
        HRESULT EnqueueMakeResident(D3D12_RESIDENCY_FLAGS Flags, int NumObjects, /* _In_reads_(NumObjects) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] ID3D12Pageable[] ppObjects, /* _In_ */ ID3D12Fence pFenceToSignal, ulong FenceValueToSignal);
    }
}
