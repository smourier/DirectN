...
namespace DirectN
{
    ...
    public partial struct _DXGK_CONNECTION_CHANGE__union_0
    {
        ...
        public byte[] __bits;
        public _DXGK_CONNECTION_CHANGE__union_0__struct_0 MonitorConnect { get => InteropRuntime.Get<_DXGK_CONNECTION_CHANGE__union_0__struct_0>(__bits, 0, 32); set { if (__bits == null) __bits = new byte[8]; InteropRuntime.Set<_DXGK_CONNECTION_CHANGE__union_0__struct_0>(value, __bits, 0, 32); } }
