...
namespace DirectN
{
    ...
    public partial interface IDWriteFontSet3 : IDWriteFontSet2
    {
        ...
        [PreserveSig]
        HRESULT GetFontSourceName(uint listIndex, /* _Out_writes_z_(stringBufferSize) */ [Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] char[] stringBuffer, uint stringBufferSize);
    }
}
