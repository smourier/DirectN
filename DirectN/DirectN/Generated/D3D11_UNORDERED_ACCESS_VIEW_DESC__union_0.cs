...
namespace DirectN
{
    ...
    public partial struct D3D11_UNORDERED_ACCESS_VIEW_DESC__union_0
    {
        ...
        public D3D11_TEX2D_UAV Texture2D => InteropRuntime.GetBits<D3D11_TEX2D_UAV>(__bits, 0, 32);
        public D3D11_TEX2D_ARRAY_UAV Texture2DArray => InteropRuntime.GetBits<D3D11_TEX2D_ARRAY_UAV>(__bits, 0, 96);
