// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\vidcap.h(121,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IKsTopologyInfo
    {
        ...
        [PreserveSig]
        HRESULT get_NodeName(/* [in] */ uint dwNodeId, /* [annotation][out] _Out_writes_bytes_opt_(dwBufSize) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 2)] char[] pwchNodeName, /* [in] */ uint dwBufSize, /* [annotation][out] _Out_ */ out uint pdwNameLen);
