// c:\program files (x86)\windows kits\10\include\10.0.19041.0\shared\dxgi.h(453,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IDXGIDeviceSubObject : IDXGIObject
    {
        ...
        [PreserveSig]
        HRESULT GetDevice(/* [annotation][in] _In_ */ [MarshalAs(UnmanagedType.LPStruct)] Guid riid, /* [annotation][retval][out] _COM_Outptr_ */ [MarshalAs(UnmanagedType.IUnknown)] out object ppDevice);
    }
}
