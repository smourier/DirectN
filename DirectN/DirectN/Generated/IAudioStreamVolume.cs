...
namespace DirectN
{
    ...
    public partial interface IAudioStreamVolume
    {
        ...
        [PreserveSig]
        HRESULT SetAllVolumes(/* [annotation][in] _In_ */ uint dwCount, /* [annotation][size_is][in] _In_reads_(dwCount) */ [In, Out, MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] float[] pfVolumes);
