// c:\program files (x86)\windows kits\10\include\10.0.18362.0\um\audioclient.h(1650,5)
using System;
...
namespace DirectN
{
    ...
    public partial interface IAudioStreamVolume
    {
        ...
        [PreserveSig]
        HRESULT SetAllVolumes(/* [annotation][in] _In_ */ int dwCount, /* [annotation][size_is][in] _In_reads_(dwCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] float[] pfVolumes);
