...
namespace DirectN
{
    ...
    public partial interface IDWriteFactory6 : IDWriteFactory5
    {
        ...
        [PreserveSig]
        HRESULT CreateFontResource(/* _In_ */ ref IDWriteFontFile fontFile, uint faceIndex, /* _COM_Outptr_ */ out IDWriteFontResource fontResource);
