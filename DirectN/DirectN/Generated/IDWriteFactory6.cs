// c:\program files (x86)\windows kits\10\include\10.0.17763.0\um\dwrite_3.h(2555,1)
using System;
...
namespace DirectN
{
    [Guid("f3744d80-21f7-42eb-b35d-995bc72fc223"), InterfaceType(ComInterfaceType.InterfaceIsIUnknown)]
    public partial interface IDWriteFactory6 : IDWriteFactory5
    {
        ...
        [PreserveSig]
        new HRESULT CreateFontFileReference(/* _In_z_ */ ref char filePath, /* optional(FILETIME) */ IntPtr lastWriteTime, /* _COM_Outptr_ */ out IDWriteFontFile fontFile);
        ...
        [PreserveSig]
        new HRESULT CreateTextFormat(/* _In_z_ */ ref char fontFamilyName, /* _In_opt_ */ IDWriteFontCollection fontCollection, DWRITE_FONT_WEIGHT fontWeight, DWRITE_FONT_STYLE fontStyle, DWRITE_FONT_STRETCH fontStretch, float fontSize, /* _In_z_ */ ref char localeName, /* _COM_Outptr_ */ out IDWriteTextFormat textFormat);
        ...
        [PreserveSig]
        new HRESULT CreateTextLayout(/* _In_reads_(stringLength) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] char[] @string, uint stringLength, /* _In_ */ IDWriteTextFormat textFormat, float maxWidth, float maxHeight, /* _COM_Outptr_ */ out IDWriteTextLayout textLayout);
        ...
        [PreserveSig]
        new HRESULT CreateNumberSubstitution(/* _In_ */ DWRITE_NUMBER_SUBSTITUTION_METHOD substitutionMethod, /* _In_z_ */ ref char localeName, /* _In_ */ bool ignoreUserOverride, /* _COM_Outptr_ */ out IDWriteNumberSubstitution numberSubstitution);
        ...
        [PreserveSig]
        new HRESULT CreateHttpFontFileLoader(/* optional(wchar_t) */ IntPtr referrerUrl, /* optional(wchar_t) */ IntPtr extraHeaders, /* _COM_Outptr_ */ out IDWriteRemoteFontFileLoader newLoader);
        ...
        // IDWriteFactory6
        [PreserveSig]
        HRESULT CreateFontFaceReference(/* _In_ */ IDWriteFontFile fontFile, uint faceIndex, DWRITE_FONT_SIMULATIONS fontSimulations, /* _In_reads_(fontAxisValueCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 4)] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, /* _COM_Outptr_ */ out IDWriteFontFaceReference1 fontFaceReference);
        
        [PreserveSig]
        HRESULT CreateFontResource(/* _In_ */ IDWriteFontFile fontFile, uint faceIndex, /* _COM_Outptr_ */ out IDWriteFontResource fontResource);
        
        [PreserveSig]
        HRESULT GetSystemFontSet(bool includeDownloadableFonts, /* _COM_Outptr_ */ out IDWriteFontSet1 fontSet);
        
        [PreserveSig]
        HRESULT GetSystemFontCollection(bool includeDownloadableFonts, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, /* _COM_Outptr_ */ out IDWriteFontCollection2 fontCollection);
        
        [PreserveSig]
        HRESULT CreateFontCollectionFromFontSet(IDWriteFontSet fontSet, DWRITE_FONT_FAMILY_MODEL fontFamilyModel, /* _COM_Outptr_ */ out IDWriteFontCollection2 fontCollection);
        
        [PreserveSig]
        HRESULT CreateFontSetBuilder(/* _COM_Outptr_ */ out IDWriteFontSetBuilder2 fontSetBuilder);
        
        [PreserveSig]
        HRESULT CreateTextFormat(/* _In_z_ */ ref char fontFamilyName, /* _In_opt_ */ IDWriteFontCollection fontCollection, /* _In_reads_(fontAxisValueCount) */ [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 3)] DWRITE_FONT_AXIS_VALUE[] fontAxisValues, uint fontAxisValueCount, float fontSize, /* _In_z_ */ ref char localeName, /* _COM_Outptr_ */ out IDWriteTextFormat3 textFormat);
    }
}
