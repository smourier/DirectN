...
> [!WARNING]  
As of 2025, DirectN evolutions will now happen in the [DirectNAot](https://github.com/smourier/DirectNAot) project which builds AOT-compatible DirectN code project (see below) with the main benefit of being able to ship single-file binaries. DirectN still exists, as is, mostly for .NET Framework support. We recommend you start migrating your .NET 9+ projects to DirectNAot as soon as possible. Don't hesitate to create issues in DirectNAot repository for migration issues.
> 
